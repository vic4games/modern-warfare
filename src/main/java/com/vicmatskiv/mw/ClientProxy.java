...
public class ClientProxy extends CommonProxy {
	...
	public void init(Object mod, FMLInitializationEvent event) {
		...
		renderItem.getItemModelMesher().register(CommonProxy.AK47Mag, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "AK47Mag", "inventory"));
		renderItem.getItemModelMesher().register(CommonProxy.AK74UMag, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "AK74UMag", "inventory"));
		...
		renderItem.getItemModelMesher().register(CommonProxy.G36Mag, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "G36Mag", "inventory"));
		...
		renderItem.getItemModelMesher().register(CommonProxy.Grenades, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "Grenades", "inventory"));
		...
		renderItem.getItemModelMesher().register(CommonProxy.MP5Mag, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "MP5Mag", "inventory"));
		...
		renderItem.getItemModelMesher().register(CommonProxy.Scope, 0, new ModelResourceLocation(ModernWarfareMod.MODID + ":" + "Scope", "inventory"));
