...
import com.vicmatskiv.mw.models.BFGproj;
...
public class BFG9000Factory implements GunFactory {
...
//        })
        .withTextureNames("bfg9000")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new BFG9000())
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.900000f, 1.925000f, -5.099998f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(1F, 0f, 0f, 1f);
                GL11.glScalef(2.500000f, 2.500000f, 2.500000f);
                GL11.glTranslatef(-0.900000f, 1.925000f, -4.499998f);
                })
...
//                GL11.glTranslatef(0F, 0F, -50F);
            ...
            .withFirstPersonPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.500000f, 2.500000f, 2.500000f);
                        GL11.glTranslatef(-0.900000f, 1.925000f, -4.899998f);
                    }, 230, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(1F, 0f, 0f, 1f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(10F, 1f, 0f, 0f);
                GL11.glScalef(2.500000f, 2.500000f, 2.500000f);
                GL11.glTranslatef(-0.900000f, 1.925000f, -4.699998f);
             })
...
//                         GL11.glTranslatef(-0.425000f, 0.075000f, -0.625000f);
            ...
            .withSpawnEntitySpeed(2f)
            .withSpawnEntityExplosionRadius(13f)
            .withExplosionParticleTexture("bfg-particles")
            .withSpawnEntityParticleAgeCoefficient(0.3F)
            .withSpawnEntityExplosionParticleScaleCoefficient(2.5F)
            .withSmokeParticleTexture("bfg-explosion")
            .withSpawnEntitySmokeParticleAgeCoefficient(0.05F)
            .withSpawnEntitySmokeParticleScaleCoefficient(15F)
//            .withSpawnEntityModel(new BFGproj())
//            .withSpawnEntityModelTexture("bfgproj")
