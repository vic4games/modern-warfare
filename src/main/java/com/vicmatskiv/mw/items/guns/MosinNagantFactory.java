...
//        })
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
				...
				GL11.glTranslatef(-0.300000f, 0.950000f, 0.200000f);
				
//				GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
//				GL11.glRotatef(40.000000f, 0f, 1f, 0f);
//				GL11.glRotatef(20.000000f, 0f, 0f, 1f);
//				GL11.glTranslatef(-0.200000f, 1.000000f, 0.425000f);
				})
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glTranslatef(-0.25f, 1f, 0.45f);
			...
			.withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
			    GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.39f, 0.750000f, 0.6f);
                GL11.glRotatef(-1.5F, 1f, 0f, 0f);
...
//                })
			...
			.withFirstPersonPositioningEjectSpentRound(
					...
					new Transition((renderContext) -> { // Reload position
		                ...
		                GL11.glTranslatef(-0.200000f, 1.000000f, 0.6f);
					}, 200, 20),
					new Transition((renderContext) -> { // Reload position
					    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
		                ...
		                GL11.glTranslatef(-0.200000f, 1.000000f, 0.45f);
                    }, 220, 10),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(42.000000f, 0f, 1f, 0f);
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonPositioningReloading(
				...
				new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.200000f, 1.1f, 0.425000f);
				}, 400, 50),
				new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glRotatef(-10.000000f, 1f, 0f, 0f);
...
//                    }, 250, 50))
			...
			.withFirstPersonHandPositioning(
					 (renderContext) -> {
	                     ...
	                     GL11.glRotatef(30.000000f, 0f, 0f, 1f);
	                     GL11.glTranslatef(0.250000f, -0.125000f, 0.225000f);
					 }, 
					 (renderContext) -> {
...
//					     GL11.glTranslatef(0.225000f, 0.000000f, 0.325000f);
					     ...
					     //right hand lifts bolt action
//					     GL11.glScalef(3f, 3f, 3f);
//                       GL11.glRotatef(-150.000000f, 1f, 0f, 0f);
//                       GL11.glRotatef(5.000000f, 0f, 1f, 0f);
//                       GL11.glRotatef(-45.000000f, 0f, 0f, 1f);
//                       GL11.glTranslatef(0.010000f, -0.025000f, 0.350000f);
...
//					     GL11.glTranslatef(0.120000f, -0.115000f, 0.190000f);
					 })
