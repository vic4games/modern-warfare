...
import com.vicmatskiv.mw.models.Kedr;
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.181F, -1.1F, -2.22F);
                GL11.glScaled(0.5F, 0.5F, 0.68F);
            } else if(model instanceof AK47iron) {
                GL11.glTranslatef(-0.185F, -1.4F, 0.35F);
                GL11.glScaled(0.4F, 0.5F, 0.1F);
                ...
                GL11.glTranslatef(-0.112F, -1.05F, -2.22F);
                GL11.glRotatef(180F, 0f, 0f, 1f);
                GL11.glScaled(0.07F, 0.5F, 0.68F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.23f, 0.75f, -0.85f);
                
//                GL11.glScalef(2f, 2f, 2f);
//                GL11.glRotatef(45F, 0f, 1f, 0f);
//                GL11.glScalef(2f, 2f, 2f);
//                GL11.glRotatef(6.000000f, 0f, 0f, 1f);
//                GL11.glTranslatef(-0.3f, 1.3f, -1.1f);
                })
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.4f, 0.86f, -0.825000f);
                    }, 400, 150),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.4f, 0.84f, -0.825000f);
                    }, 300, 60),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(44.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(-5.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.4f, 0.83f, -0.825000f);
                }, 100, 140),
...
//                }, 100, 0)
            ...
            .withFirstPersonPositioningUnloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-5.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.4f, 0.800000f, -0.825000f);
                    }, 250, 50),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(2f, 2f, 2f);
            ...
            .withFirstPersonPositioningInspecting(
                  ...
                  new Transition((renderContext) -> {
                      ...
                      GL11.glTranslatef(0.175000f, 0.950000f, -0.825000f);
                  }, 350, 600)
                    )
...
//                    }, 500, 1000),
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.KedrAction.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.64f, -1f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.64f, -0.9f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.075000f, -0.450000f, 0.200000f);
...
//                         GL11.glScalef(4f, 4f, 4f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.250000f, -0.725000f, 0.150000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(50.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.200000f, -0.725000f, 0.075000f);
                    }, 250, 0))
            ...
            .withFirstPersonLeftHandPositioningInspecting(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.025000f, -0.525000f, 0.000000f);
                    }, 250, 50))
