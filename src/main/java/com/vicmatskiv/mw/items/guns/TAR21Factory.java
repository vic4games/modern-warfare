      ...
      .withCompatibleAttachment(Attachments.Kobra, (model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                GL11.glTranslatef(-0.6f, 1.075000f, -1.15f);
                GL11.glRotatef(5F, 0f, 0f, 1f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holo2)) {
                    ...
                    GL11.glTranslatef(0F, 0.0785f, 0f);
                } 
                
                // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holographic2)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0F, 0.078f, 0f);
                } 
...
//              GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningReloading(
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.300000f, 1.674999f, 0.150000f);
                }, 400, 100),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.300000f, 1.674999f, 0.4f);
                }, 200, 70),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.300000f, 1.674999f, 0.6f);
                }, 180, 0)
            )
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glTranslatef(-0.5F, 2.8F, -2F);
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
...
//                         GL11.glRotatef(-100f, 1f, 0f, 0f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(10.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(15.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.100000f, -0.050000f, 0.225000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.050000f, -0.300000f, 0.200000f);
                    }, 250, 0),
