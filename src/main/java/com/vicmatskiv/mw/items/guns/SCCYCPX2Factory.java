...
import com.vicmatskiv.mw.models.SCCYCPX2Slide;
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
                ...
                GL11.glTranslatef(-0.155F, -1.09F, -0.15F);
                GL11.glScaled(0.3F, 0.3F, 0.4F);
            }
            else if(model instanceof M9A1frontsight) {
                GL11.glTranslatef(-0.145F, -1.085F, -1.5F);
                GL11.glScaled(0.22F, 0.22F, 0.3F);
            }
        })
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(), (renderContext) -> {
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.SCCYCPX2Mag,
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.SCCYCPX2Mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.SCCYCPX2Slide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.350000f, 0.56f, -2f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
                GL11.glTranslatef(0.350000f, 0.56f, -1.8f);
                GL11.glRotatef(-3F, 1f, 0f, 0f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                   ...
                   (renderContext) -> {
                       ...
                       GL11.glTranslatef(0.400000f, -0.505000f, 0.150000f);
                   })
