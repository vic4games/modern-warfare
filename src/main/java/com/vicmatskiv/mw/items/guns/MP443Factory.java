...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.4f, 1.7f, -3.7f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glRotatef(8F, 0f, 0f, 1f);
                GL11.glTranslatef(-0.4f, 1.7f, -3.5f);
...
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.35f, 1.95f, -3.4f);
                    }, 300, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.3f, 1.95f, -3.4f);
                    }, 200, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.5f, 1.95f, -3.4f);
                    }, 200, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-3F, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.2f, 1.95f, -3.4f);
                    }, 70, 0)
                )
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.23f, 1.95f, -3.4f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.1f, 1.95f, -3.4f);
                    }, 230, 0)
                )
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(4F, 0f, 0f, 1f);
                        GL11.glRotatef(-2F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.8f, 2.05f, -3.4f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        ...
                        GL11.glTranslatef(-0.8f, 2.15f, -3.35f);
                    }, 130, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(35F, 0f, 1f, 0f);
                        GL11.glRotatef(4F, 0f, 0f, 1f);
                        GL11.glRotatef(-2F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.8f, 2.08f, -3.4f);
                    }, 120, 0)
                    )
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.03f, 1.43f, -3.5f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
                GL11.glTranslatef(0.03f, 1.35f, -3.3f);
                GL11.glRotatef(-3F, 1f, 0f, 0f);
