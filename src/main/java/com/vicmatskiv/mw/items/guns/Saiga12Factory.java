...
public class Saiga12Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCrafting(CraftingComplexity.MEDIUM, 
                ...
                Ores.INGOT_STEEL)
        .withInformationProvider(stack -> Arrays.asList("Type: Shotgun", "Damage per Pellet: 6.3", "Pellets per Shot: 11",  
...
//          GL11.glRotatef(7F, 1f, 0f, 0f);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.Saiga12mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.Saiga12mag,
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0.05F, 1.5F, -0.5F);
                        GL11.glRotatef(-30F, 1f, 0f, 0f);
                    }, 250, 1000),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.75f, -0.15f);
