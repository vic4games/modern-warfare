...
import com.vicmatskiv.mw.models.KA_AK12;
...
public class Kalashnikov_AK12Factory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
        .withModId(ModernWarfareMod.MODID)
        .withName("kalashnikov_ak12")
        .withFireRate(0.6f)
        .withRecoil(3.5f)
        .withZoom(0.9f)
...
//            GL11.glTranslatef(0F, 3.75F, -0.75F);
//            GL11.glRotatef(-10F, 1f, 0f, 0f);
        })
        .withCompatibleAttachment(Attachments.AK12ironsight, true, (model) -> {
            if(model instanceof KA_AK12_Ironsight) {
                GL11.glTranslatef(-0.161F, -1.45F, -0.35F);
                GL11.glScaled(0.52F, 0.52F, 0.52F);
            } else if(model instanceof AKMiron2) {
            	GL11.glTranslatef(-0.175F, -1.32F, -5F);
                GL11.glScaled(0.45F, 0.45F, 0.68F);
            }
        })
        .withCompatibleAttachment(Attachments.KobraGen3, true, (player, stack) -> {
            GL11.glTranslatef(-0.025F, -1.26F, -1.12F);
        ...
        .withCompatibleAttachment(Attachments.Laser2, true, (p, s) -> {
		    GL11.glTranslatef(-0.218F, -1.17F, -3.9F);
        ...
        .withTextureNames("ka_ak12")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new KA_AK12())
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                     ...
                     GL11.glTranslatef(-0.205000f, 1.085000f, -0.375000f);
                     
//	            	 GL11.glScalef(2.5f, 2.5f, 2.5f);
//	                 GL11.glRotatef(-25.000000f, 1f, 0f, 0f);
//	                 GL11.glRotatef(25.000000f, 0f, 1f, 0f);
//	                 GL11.glRotatef(35.000000f, 0f, 0f, 1f);
//	                 GL11.glTranslatef(0.000000f, 1.399999f, 0.500000f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
	                ...
	                GL11.glScalef(2.5f, 2.5f, 2.5f);
	                GL11.glRotatef(2.000000f, 0f, 0f, 1f);
	                GL11.glTranslatef(-0.205000f, 1.105000f, 0.075000f);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.600000f, 0.875000f, -0.200000f);
                    }, 300, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.600000f, 0.775000f, -0.200000f);
                    }, 260, 70),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-25.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.800000f, 0.575000f, -0.18f);
                }, 190, 50),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.800000f, 0.575000f, 0.1f);
                }, 90, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-23.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.800000f, 0.575000f, 0f);
                }, 40, 0)
            )
            ...
            .withFirstPersonPositioningUnloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.500000f, 0.995000f, -0.200000f);
                    }, 190, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(2.5f, 2.5f, 2.5f);
                        ...
                        GL11.glTranslatef(-0.500000f, 0.975000f, -0.220000f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(2.5f, 2.5f, 2.5f);
                        ...
                        GL11.glTranslatef(-0.500000f, 0.995000f, -0.210000f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(2.5f, 2.5f, 2.5f);
                        GL11.glRotatef(-18.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glTranslatef(-0.500000f, 0.975000f, -0.200000f);
                    }, 230, 0)
                    )
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.AK15Mag,
                    ...
                    new Transition((renderContext) -> {
                    	GL11.glTranslatef(0F, 1.25F, -0.75F);
...
//                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                    	GL11.glRotatef(15.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.000000f, 1.449999f, 0.500000f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(2.5f, 2.5f, 2.5f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.000000f, 1.599999f, 0.750000f);
                    }, 160, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(2.5f, 2.5f, 2.5f);
                        GL11.glRotatef(-27.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glRotatef(28.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.000000f, 1.399999f, 0.70000f);
                    }, 40, 0)
                    )
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.345f, 0.81f, -0.5f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
            	GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.345f, 0.81f, -0.2f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                GL11.glRotatef(10.000000f, 1f, 0f, 0f);
                GL11.glTranslatef(-0.150000f, 1.175000f, 0.050000f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                             ...
                             GL11.glTranslatef(0.350000f, -0.175000f, 0.100000f);
...
//	                    	 GL11.glScalef(4f, 4f, 4f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(60.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.675000f, -0.500000f, 0.025000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(-65.000000f, 0f, 1f, 0f);
                    	GL11.glRotatef(60.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.150000f, -0.425000f, 0.000000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.050000f, -0.350000f, 0.075000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.025000f, -0.400000f, 0.250000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(-70.000000f, 0f, 1f, 0f);
                    	GL11.glRotatef(65.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(-0.150000f, -0.525000f, 0.250000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glTranslatef(-0.200000f, -0.625000f, 0.250000f);
                    }, 250, 0))
            ...
            .withFirstPersonLeftHandPositioningUnloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(60.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.050000f, -0.450000f, -0.050000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(-65.000000f, 0f, 1f, 0f);
                    	GL11.glRotatef(60.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.350000f, -0.475000f, 0.025000f);
                    }, 50, 200),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(4f, 4f, 4f);
                    	GL11.glRotatef(-30.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonRightHandPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(4f, 4f, 4f);
	                   	 ...
	                   	 GL11.glRotatef(30.000000f, 0f, 1f, 0f);
	                   	 GL11.glRotatef(-45.000000f, 0f, 0f, 1f);
	                   	 GL11.glTranslatef(0.200000f, 0.025000f, 0.000000f);
                    }, 250, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(4f, 4f, 4f);
                        ...
                        GL11.glRotatef(30.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(-50.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.075000f, -0.225000f, 0.150000f);
                    }, 280, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(4f, 4f, 4f);
                    	...
                    	GL11.glRotatef(30.000000f, 0f, 1f, 0f);
                    	GL11.glRotatef(-50.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.175000f, -0.425000f, 0.150000f);
                    }, 280, 0)
                    )
