        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.475000f, 0.925000f, -1.724999f);
...
//                GL11.glScalef(1.5f, 1.5f, 1.5f);
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(1.5f, 1.5f, 1.5f);
                GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.475000f, 0.925000f, -1.124999f);
            ...
            .withFirstPersonPositioningCustomRecoiled(Attachments.MAC10Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(Attachments.MAC10Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.449999f, 1.304999f, -1.499999f);
                    }, 300, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.449999f, 1.264999f, -1.499999f);
                    }, 200, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.449999f, 1.284999f, -1.499999f);
                    }, 100, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.449999f, 1.224999f, -1.499999f);
                    }, 100, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-1.449999f, 1.044999f, -1.499999f);
                }, 70, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-1.449999f, 1.04999f, -1.499999f);
                }, 80, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-1.449999f, 1.104999f, -1.499999f);
                }, 130, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.800000f, 1.549999f, -1.394999f);
                }, 200, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.800000f, 1.549999f, -1.384999f);
                }, 50, 0),
                
                // left hand pulls action back
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.800000f, 1.549999f, -1.164999f);
                }, 100, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.800000f, 1.549999f, -1.204999f);
                }, 100, 0),
             ...
             // lets go of action
                ...
                new Transition((renderContext) -> { // Reload position
                	GL11.glScalef(1.5f, 1.5f, 1.5f);
                    GL11.glRotatef(-6.300000f, 1f, 0f, 0f);
                    GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(19.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.800000f, 1.549999f, -1.374999f);
                }, 80, 0),
            ...
            .withFirstPersonPositioningUnloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(30.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(-6.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.449999f, 1.214999f, -1.499999f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(1.5f, 1.5f, 1.5f);
                        ...
                        GL11.glTranslatef(-1.449999f, 1.254999f, -1.499999f);
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(1.5f, 1.5f, 1.5f);
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.MAC10Mag,
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.MAC10Mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningReloading(Attachments.MAC10Action.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-15.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.875000f, 0.775000f, -1.299999f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                	  GL11.glScalef(1.5f, 1.5f, 1.5f);
                	  GL11.glRotatef(-25.000000f, 1f, 0f, 0f);
                	  ...
                	  GL11.glTranslatef(0.325000f, 1.749999f, -0.975000f);
                  }, 350, 600)
                    )
...
//                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(20.000000f, 0f, 0f, 1f);
                        GL11.glRotatef(25.000000f, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.475000f, 0.925000f, -1.864999f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(1.5f, 1.5f, 1.5f);
                        ...
                        GL11.glTranslatef(-0.475000f, 0.925000f, -1.824999f);
                    }, 90, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(1.5f, 1.5f, 1.5f);
                        ...
                        GL11.glTranslatef(-0.475000f, 0.925000f, -1.774999f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(1.5f, 1.5f, 1.5f);
                        ...
                        GL11.glTranslatef(-0.475000f, 0.925000f, -1.664999f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(1.5f, 1.5f, 1.5f);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.353f, 0.9f, -2f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
            	GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.353f, 0.9f, -1.6f);
                GL11.glRotatef(-1F, 1f, 0f, 1f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glRotatef(-15.000000f, 0f, 0f, 1f);
                 GL11.glTranslatef(-1.6f, 0.675000f, -1.3f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         if(activeAttachment == Attachments.Grip2 ||
                             ...
                             GL11.glRotatef(0.000000f, 0f, 1f, 0f);
                             GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                             GL11.glTranslatef(0.350000f, -0.125000f, 0.450000f);
...
//                             GL11.glScalef(4f, 4f, 4f);
                     ...
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.400000f, -0.465000f, 0.170000f);
                     })
            ...
            .withFirstPersonHandPositioningModifying(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.200000f, 0.025000f, 0.575000f);
                     }, 
                     (renderContext) -> {
                    	 GL11.glScalef(4f, 4f, 4f);
                         GL11.glRotatef(-105.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                    	GL11.glTranslatef(0.575000f, -0.400000f, 0.150000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glTranslatef(0.300000f, -0.525000f, 0.125000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(40.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.150000f, -0.500000f, 0.200000f);
                    }, 250, 0),
                 ...
                 // left hand goes to action
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.025000f, -0.500000f, 0.000000f);
                    }, 160, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                    	...
                    	GL11.glTranslatef(-0.200000f, -0.650000f, -0.025000f);
                    }, 100, 0),
