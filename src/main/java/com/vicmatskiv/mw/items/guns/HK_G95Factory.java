...
public class HK_G95Factory implements GunFactory {
...
//          GL11.glTranslatef(0f, 0f, 1f);
        ...
        .withCompatibleAttachment(Attachments.AimpointCompM5, true, (player, stack) -> {
            GL11.glTranslatef(-0.19F, -1.45F, -1.4F);
        ...
        .withCompatibleAttachment(Attachments.StubbyGrip, true, (model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.215000f, 1.249999f, -0.775000f);
...
//                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(9F, 0f, 0f, 1f);
                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                GL11.glTranslatef(-0.215000f, 1.249999f, -0.275000f);
...
//                GL11.glTranslatef(0F, 0.5F, 0F);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.0000f, 1.199999f, -0.600000f);
                    }, 70, 0)
                    )
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-15.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.650000f, 1.23f, -0.750000f);
                    }, 150, 0),
                    new Transition((renderContext) -> {
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        ...
                        GL11.glTranslatef(-0.650000f, 1.135000f, -0.750000f);
                    }, 160, 0)
                    )
...
//                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 1.078f, 0.9f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 1.078f, 1.1f);
