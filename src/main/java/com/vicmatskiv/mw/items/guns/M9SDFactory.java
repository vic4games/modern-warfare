...
//			GL11.glScaled(0.55F, 0.55F, 0.55F);
		...
		.withCompatibleAttachment(CommonProxy.M9SDsuppressor, true, (model) -> {
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.M9Top.getRenderablePart(), (player, itemStack) -> {
...
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
			...
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.M9Top.getRenderablePart(), (player, itemStack) -> {
				GL11.glTranslatef(0F, 0F, 0.5F);
//				GL11.glRotatef(45F, 0f, 1f, 0f);
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
				})
			...
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.M9SDsuppressor.getRenderablePart(), (player, itemStack) -> {})
			
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.M9SDsuppressor.getRenderablePart(), (player, itemStack) -> {})
			...
			.withFirstPersonCustomPositioning(CommonProxy.M9Top.getRenderablePart(), (player, itemStack) -> {
				if(Tags.getAmmo(itemStack) == 0) {
					GL11.glTranslatef(0F, 0F, 0.5F);
				}
			})
			
			.withFirstPersonCustomPositioning(CommonProxy.M9SDsuppressor.getRenderablePart(), (player, itemStack) -> {
				if(Tags.getAmmo(itemStack) == 0) {
					GL11.glTranslatef(0F, 0F, 0.5F);
				}
			})
...
//				    GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioningReloading(CommonProxy.M9SDsuppressor.getRenderablePart(),
				new Transition((player, itemStack) -> {
...
//				    GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioningUnloading(CommonProxy.M9SDsuppressor.getRenderablePart(),
				new Transition((player, itemStack) -> {
