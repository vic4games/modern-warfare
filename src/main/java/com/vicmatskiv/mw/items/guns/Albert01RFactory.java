...
import com.vicmatskiv.mw.models.Albert01R;
...
public class Albert01RFactory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withZoom(0.9f)
        .withMaxShots(1)
        .withShootSound("albert01r")
        .withSilencedShootSound("albert01r_silenced")
...
//      .withShellCasingForwardOffset(0.001f)
       ...
       .withCompatibleAttachment(Magazines.M9A1Mag, (model) -> {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Albert01Rslide, true, (model) -> {
            if(model instanceof Albert01RSlide) {
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
        ...
        .withCompatibleAttachment(Attachments.Laser, (p, s) -> {
            GL11.glTranslatef(0.03F, -0.6F, -2.2F);
            GL11.glScaled(1.3F, 1.3F, 1.3F);
            GL11.glRotatef(-90F, 0f, 0f, -4f);
        })
        .withCompatibleAttachment(Attachments.SilencerEABH, (model) -> {
            GL11.glTranslatef(-0.24F, -1.15F, -4.35F);
            GL11.glScaled(1.5F, 1.5F, 1.4F);
        })
        ...
        .withTextureNames("Albert01R")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new Albert01R())
            //.withTextureName("M9")
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(), (renderContext) -> {
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.Albert01Rslide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
                GL11.glTranslatef(0.350000f, 0.64f, -1.9f);
                GL11.glRotatef(-3F, 1f, 0f, 0f);
