...
public class M8A7Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M8A7Mag, true, (model) -> {
...
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        ...
        .withCompatibleAttachment(Attachments.Grip2, (model) -> {
            GL11.glTranslatef(-0.2F, -0F, -2.9F);
        ...
        .withCompatibleAttachment(Attachments.Silencer556x45, (model) -> {
            GL11.glTranslatef(-0.2F, -1.1F, -6.5F);
            GL11.glScaled(1F, 1F, 1F);
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.5f, 1.15f, -1.1f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(-3F, 0f, 0f, 1f);
                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                GL11.glTranslatef(-0.5f, 1.15f, -0.95f);
...
//              GL11.glTranslatef(0f, 0f, 0.5f);
            ...
            .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.5f, 1.15f, -1f);
                    }, 180, 20),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.6f, 1.15f, -1f);
                    }, 240, 100),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.62f, 1.399999f, -1.25000f);
                    }, 280, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(-1F, 1f, 0f, 0f);
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(-0.62f, 1.36f, -1.1f);
                    }, 180, 40),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(-1F, 1f, 0f, 0f);
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(-0.62f, 1.36f, -1.15f);
                    }, 250, 0)
                    )
                    
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M8A7Mag.getRenderablePart(),
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M8A7Mag.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                      }, 250, 1000),
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 1.07f, -0.4f);
...
//                } 
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 1.07f, -0.3f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.200000f, -0.100000f, 0.175000f);
...
//                         GL11.glScalef(4f, 4f, 4f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.125000f, -0.525000f, 0.000000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(4f, 4f, 4f);
                        ...
                        GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.250000f, -0.675000f, -0.025000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(4f, 4f, 4f);
                        GL11.glRotatef(-110.000000f, 1f, 0f, 0f);
