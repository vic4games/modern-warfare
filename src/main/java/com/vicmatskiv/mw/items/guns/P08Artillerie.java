...
public class P08Artillerie {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withInformationProvider(stack -> Arrays.asList("Type: Pistol Carbine", "Damage: 8.5", 
...
//        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.8f, 0.9f, -3f);
...
//                GL11.glTranslatef(-0.75f, 1.5f, -2.7f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
                GL11.glTranslatef(0.345f, 0.45f, -2f);
...
//                      GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.550000f, 1.224999f, -0.3f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(-0.000000f, -0.500000f, 0.150000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(4.5f, 4.5f, 4.5f);
                         ...
                         GL11.glTranslatef(0.400000f, -0.550000f, 0.175000f);
                     })
            ...
            .withFirstPersonRightHandPositioningInspecting(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-55.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.38f, -0.52f, 0.18f);
                    }, 250, 50),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(4.500000f, 4.500000f, 4.500000f);
                        GL11.glRotatef(-100.000000f, 1f, 0f, 0f);
