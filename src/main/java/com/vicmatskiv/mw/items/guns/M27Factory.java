...
import com.vicmatskiv.mw.models.M27;
...
//		.withAmmoCapacity(30)
		...
		.withInformationProvider(stack -> Arrays.asList("Type: Assault rifle/Designated marksmen rifle", "Damage: 7", 
		...
		.withCompatibleAttachment(CommonProxy.NATODrum100, (model) -> {
		 ...
		 .withCompatibleAttachment(CommonProxy.AKMIron, true, (model) -> {
		    	if(model instanceof M4Iron1) {
					...
					GL11.glTranslatef(0.255F, -1.55F, -2.9F);
					...
					GL11.glTranslatef(0.127F, -1.77F, -2.9F);
			...
			.withCompatibleAttachment(CommonProxy.Silencer556x45, (model) -> {
				GL11.glTranslatef(0.107F, -1.5F, -4.87F);
