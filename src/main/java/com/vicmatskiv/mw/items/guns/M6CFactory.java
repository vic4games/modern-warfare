...
public class M6CFactory implements GunFactory {
...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M6Cslide, true, (model) -> {
            if(model instanceof M6CSlide) {
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
                ...
                GL11.glTranslatef(-0.15F, -1.37F, -1.35F);
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M6Cslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.M6Cslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.M6Cslide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
