...
import com.vicmatskiv.mw.models.M6C;
import com.vicmatskiv.mw.models.M6CSOCOM;
import com.vicmatskiv.mw.models.M6CSOCOMSlide;
import com.vicmatskiv.mw.models.M6Crearsight;
...
public class M6CSOCOMFactory implements GunFactory {
...
//                GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            else if(model instanceof M6Crearsight) {
                GL11.glTranslatef(-0.215F, -1.4F, 0.16F);
                GL11.glScaled(0.4F, 0.4F, 0.4F);
            }
        })
        .withCompatibleAttachment(AuxiliaryAttachments.M6CSOCOMMag, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.M6CSOCOMsight, true, (model) -> {
            GL11.glTranslatef(-0.15F, -1.37F, -3.1F);
...
//        })
        .withTextureNames("m6csocom")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new M6CSOCOM())
            //.withTextureName("M9")
...
//                GL11.glTranslatef(-0.55f, 1.15f, -2.5f);
                })
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.6F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M6CSOCOMMag.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.M6CSOCOMMag.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(), (renderContext) -> {
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.6f, 1.2f, -2.5f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.7f, 1.1f, -2.5f);
                    }, 170, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.7f, 0.8f, -2.5f);
                    }, 350, 0),
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M6CSOCOMMag.getRenderablePart(),
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M6CSOCOMMag.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.025000f, 2.199999f, -1.274999f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(-10.000000f, 1f, 0f, 0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.425000f, 2.199999f, -1.1f);
                    }, 130, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.M6CSOCOMSlide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.350000f, 0.8f, -2.3f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(-0.125000f, -0.725000f, 0.075000f);
                   }, 
                   (renderContext) -> {
                       GL11.glScalef(5f, 5f, 5f);
                       ...
                       GL11.glTranslatef(0.375000f, -0.525000f, 0.160000f);
                   })
