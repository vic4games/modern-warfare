...
public class GunwerksHAMRFactory implements GunFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
        .withModId(ModernWarfareMod.MODID)
        .withName("GunwerksHAMR")
...
//      .withAmmoCapacity(10)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.GunwerksHAMRaction, true, (model) -> {
        })
        ...
        .withCompatibleAttachment(Attachments.Scope, (player, stack) -> {
            GL11.glTranslatef(-0.11F, -2.02F, -0.5F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (model) -> {
            if(model instanceof Reflex) {
                GL11.glTranslatef(0.165F, -1.87F, -0.7F);
                GL11.glScaled(0.37F, 0.37F, 0.37F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(0.115F, -2.105F, -0.7F);
                GL11.glScaled(0.08F, 0.08F, 0.08F);
            }
        })
        .withCompatibleAttachment(Attachments.Holo2, (model) -> {
            if(model instanceof Holographic) {
                GL11.glTranslatef(0.175F, -1.87F, -0.7F);
                GL11.glScaled(0.48F, 0.48F, 0.48F);
            } else if(model instanceof Holo2) {
                GL11.glTranslatef(0.115F, -2.09F, -0.7F);
        ...
        .withCompatibleAttachment(Attachments.Kobra, (model) -> {
            if(model instanceof Kobra) {
                GL11.glTranslatef(0.18F, -1.9F, -0.3F);
                GL11.glScaled(0.48F, 0.48F, 0.48F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(0.115F, -2.1F, -0.7F);
                GL11.glScaled(0.08F, 0.08F, 0.08F);
            }
        })
        .withCompatibleAttachment(Attachments.MicroT1, (model) -> {
            if(model instanceof MicroT1) {
                GL11.glTranslatef(0.07F, -2.04F, -0.5F);
                GL11.glScaled(0.3F, 0.3F, 0.3F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(0.115F, -2.14F, -0.7F);
                GL11.glScaled(0.08F, 0.08F, 0.08F);
            }
        })
        .withCompatibleAttachment(Attachments.RMR, (model) -> {
            if(model instanceof RMRsight) {
                GL11.glTranslatef(0.08F, -2.04F, -0.1F);
                GL11.glScaled(0.25F, 0.25F, 0.25F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(0.115F, -2.04F, -0.3F);
                GL11.glScaled(0.08F, 0.08F, 0.08F);
            }
        })
...
//        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.75f, 1.55f, -1.5f);
                
//                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
//                GL11.glRotatef(5.000000f, 1f, 0f, 0f);
//                GL11.glRotatef(25.000000f, 0f, 1f, 0f);
//                GL11.glRotatef(30.000000f, 0f, 0f, 1f);
//                GL11.glTranslatef(-0.475000f, 1.724999f, -1.699999f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glRotatef(5f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.75f, 1.63f, -1.1f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
             ...
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HP)) {
                    ...
                    GL11.glTranslatef(0F, 0.3f, 1.85f);
                } 
                
                // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Scope)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.3f, 2.15f);
                } 
                
                // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.295f, 2.2f);
                } 
                
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.2f, 2.45f);
                } 
                
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.21f, 2.4f);
                } 
                
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.17f, 1.9f);
                } 
             ...
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Kobra)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0F, 0.17f, 1.8f);
                } 
                
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.RMR)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0.002F, 0.11f, 1.2f);
                } 
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.GunwerksHAMRaction.getRenderablePart(), (renderContext) -> {
                })
            ...
            .withFirstPersonPositioningEjectSpentRound(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(27.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.475000f, 1.724999f, -1.5f);
                    }, 160, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(5.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.475000f, 1.724999f, -1.6f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
            ...
            .withFirstPersonCustomPositioningEjectSpentRound(AuxiliaryAttachments.GunwerksHAMRaction.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 250, 50),
                    new Transition((renderContext) -> { // Reload position
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
             ...
             .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(5f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.850000f, 1.7f, -1.8f);
            ...
            .withFirstPersonPositioningUnloading(
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(43F, 0f, 1f, 0f);
                    GL11.glRotatef(7f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.850000f, 1.574999f, -1.8f);
                    GL11.glRotatef(2f, 1f, 0f, 0f);
                }, 150, 50),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.GunwerksHAMRaction.getRenderablePart(),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.175000f, -0.250000f, 0.100000f);
                     }, 
                     (renderContext) -> {
