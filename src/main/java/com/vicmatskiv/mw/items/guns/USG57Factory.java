...
//      .withAmmoCapacity(10)
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.3f, 0.8f, -3.2f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(4F, 0f, 0f, 1f);
                GL11.glScaled(2F, 2F, 2F);
                GL11.glTranslatef(-0.3f, 0.8f, -3.05f);
...
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glTranslatef(-0.3f, 1.4f, -2.7f);
                    }, 360, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glTranslatef(-0.43f, 0.8f, -2.7f);
                    }, 200, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glTranslatef(-0.45f, 0.8f, -2.7f);
                    }, 160, 150),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glTranslatef(-0.44f, 1.1f, -2.7f);
                    }, 250, 50),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(2F, 1f, 0f, 0f);
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glTranslatef(-0.33f, 0.7f, -2.7f);
                    }, 120, 0)
...
//                    GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glTranslatef(-1.149999f, 0.575000f, -0.9f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScaled(2F, 2F, 2F);
                      ...
                      GL11.glTranslatef(0.375000f, 0.950000f, -1.5f);
                  }, 350, 600)
                    )
