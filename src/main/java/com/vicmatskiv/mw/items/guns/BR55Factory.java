...
//            GL11.glRotatef(-35F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.BR55Mag, true, (model) -> {
...
//            GL11.glScaled(0.75F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
            GL11.glTranslatef(-0.14F, -2.05F, -2.4F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
            GL11.glTranslatef(-0.01F, -2.12F, -2.7F);
        ...
        .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
            GL11.glTranslatef(0.01F, -2.2F, -2.7F);
...
//                GL11.glTranslatef(0.200000f, 1.699999f, 0.000000f);
                })
...
//                GL11.glRotatef(-0.3F, 1f, 0f, 0f);
            ...
            new Transition((renderContext) -> { // Reload position
                ...
                GL11.glTranslatef(-0.750000f, 1.3f, -0.400000f);
            ...
            new Transition((renderContext) -> { // Reload position
                ...
                GL11.glTranslatef(-0.750000f, 1.4f, -0.200000f);
            ...
            new Transition((renderContext) -> { // Reload position
                ...
                GL11.glTranslatef(-0.750000f, 1.5f, -0.300000f);
                GL11.glRotatef(-2.000000f, 1f, 0f, 0f);
            }, 190, 0)
            )
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.BR55Mag.getRenderablePart(),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glTranslatef(-1.3f, 1.4f, -0.5f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                      GL11.glRotatef(75.000000f, 0f, 0f, 1f);
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.BR55Mag.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.BR55Action.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.750000f, 1.774999f, -0.400000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.750000f, 1.574999f, -0.400000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.750000f, 1.474999f, -0.400000f);
                        GL11.glRotatef(2.000000f, 1f, 0f, 0f);
                    }, 270, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(41F, 0f, 1f, 0f);
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.750000f, 1.474999f, -0.200000f);
                        GL11.glRotatef(-4.000000f, 1f, 0f, 0f);
                    }, 190, 100),
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.750000f, 1.474999f, -0.300000f);
                        GL11.glRotatef(-2.000000f, 1f, 0f, 0f);
                    }, 190, 0)
                    )
                    
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.BR55Action.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.3f, 1.75f, 1f);
             ...
             // ACOG Zoom
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0.01F, 0.15f, 1.1f);
                } 
...
//                } 
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.3f, 1.75f, 1.15f);
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.BR55Scope)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0.01F, 0.11f, 0.9f);
                } 
                
                // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0.01F, 0.15f, 1f);
                } 
...
//                } 
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.250000f, -0.275000f, 0.025000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(6f, 6f, 6f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.350000f, -1.224999f, 0.150000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-60.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.075000f, -1.100000f, 0.225000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-60.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.050000f, -1.274999f, 0.250000f);
            ...
            .withFirstPersonLeftHandPositioningInspecting(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(55.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.225000f, -0.275000f, -0.150000f);
                    }, 250, 50))
