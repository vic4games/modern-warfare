...
//                GL11.glTranslatef(0F, 0F, 0.5F);
                ...
                GL11.glTranslatef(-0.024F, -0.46F, 0.38F);
                GL11.glScaled(0.17F, 0.12F, 0.2F);
            }
            else if(model instanceof M1911frontsight) {
                GL11.glTranslatef(-0.02F, -0.455F, -0.85F);
                GL11.glScaled(0.16F, 0.18F, 0.34F);
            }
        })
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.VP70slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.4F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.VP70slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.4F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.925000f, 0.23f, -1.5f);
                    }, 200, 10),
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.925000f, 0.12f, -1.5f);
                    }, 130, 0)
                )
                    
            .withFirstPersonCustomPositioningReloading(Magazines.VP70Mag,
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.VP70Mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.VP70slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.4F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.VP70slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.4F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.149999f, 0.2f, -0.725000f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScaled(2F, 2F, 2F);
                      ...
                      GL11.glTranslatef(0.375000f, 0.4f, -1.075000f);
                  }, 350, 600)
                    )
            ...
            .withFirstPersonPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(40F, 0f, 0f, 1f);
                        GL11.glRotatef(-2F, 1f, 0f, 0f);
                        GL11.glTranslatef(0f, 0.3f, -1.8f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        ...
                        GL11.glTranslatef(0f, 0.4f, -1.75f);
                    }, 130, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.VP70slide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.245f, -0.11f, -2f);
...
//                        GL11.glScalef(000f, 00f, 0000f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.125000f, -1.000000f, 0.050000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(65.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.075000f, -0.925000f, 0.225000f);
                    }, 50, 200),
...
//                        GL11.glScalef(000f, 00f, 0000f);
            ...
            .withFirstPersonLeftHandPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.675000f, -0.700000f, -0.050000f);
                    }, 130, 60),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(4f, 4f, 4f);
                        GL11.glRotatef(-200.000000f, 1f, 0f, 0f);
