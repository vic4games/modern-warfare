...
//		.withAmmoCapacity(30)
		...
		.withCompatibleAttachment(CommonProxy.BushmasterACRRail, true, (model) -> {
        ...
        .withCompatibleAttachment(CommonProxy.BushmasterACRAction, true, (model) -> {
...
//				GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioning(CommonProxy.BushmasterACRRail.getRenderablePart(), (renderContext) -> {
//              GL11.glTranslatef(0.25F, -0.32F, -0.2F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
//              GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningCustomRecoiled(CommonProxy.BushmasterACRRail.getRenderablePart(), (renderContext) -> {
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.BushmasterACRRail.getRenderablePart(), (renderContext) -> {
                })
                
            .withFirstPersonCustomPositioning(CommonProxy.BushmasterACRAction.getRenderablePart(), (renderContext) -> {
//              GL11.glTranslatef(0.25F, -0.32F, -0.2F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
//              GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningCustomRecoiled(CommonProxy.BushmasterACRAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 0.9f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.BushmasterACRAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 0.9f);
                })
...
//					GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioningReloading(CommonProxy.BushmasterACRRail.getRenderablePart(),
                new Transition((renderContext) -> {
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningUnloading(CommonProxy.BushmasterACRRail.getRenderablePart(),
                new Transition((renderContext) -> {
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
           ...
           .withFirstPersonCustomPositioningReloading(CommonProxy.BushmasterACRAction.getRenderablePart(),
                new Transition((renderContext) -> {
//                    GL11.glTranslatef(0.05F, 1F, 0F);
//                  GL11.glRotatef(0F, 0f, 1f, 0f);
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningUnloading(CommonProxy.BushmasterACRAction.getRenderablePart(),
                new Transition((renderContext) -> {
//                    GL11.glTranslatef(0.2F, 0.5F, -0.2F);
//                    GL11.glRotatef(-20F, 1f, 0f, 0f);
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
