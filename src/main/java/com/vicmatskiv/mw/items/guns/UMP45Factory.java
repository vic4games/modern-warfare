...
import com.vicmatskiv.mw.models.UMP45Bare;
import com.vicmatskiv.mw.models.UTGTriRailHandGuard;
import com.vicmatskiv.mw.models.Written45ACP;
...
//             GL11.glScaled(0F, 0F, 0F);
         ...
         .withCompatibleAttachment(Attachments.UMP45Receiver, true, (model) -> {
             if(model instanceof UMP45) {
//               GL11.glTranslatef(0F, -0.03F, 0F);
//               GL11.glScaled(1F, 1F, 1F);
             } else if(model instanceof Written45ACP) {
            	 GL11.glTranslatef(0.041f, -1.58f, -0.9f);
...
//               GL11.glScaled(1F, 1F, 1F);
            	 ...
            	 GL11.glTranslatef(0.041f, -1.54f, -0.9f);
                 GL11.glScaled(1.5F, 1.5F, 1.5F);
             } 
         })
//        .withCompatibleAttachment(Attachments.MP5A5HandGuard, true, (model) -> {
//        })
//        .withCompatibleAttachment(AuxiliaryAttachments.MP5A5action, true, (model) -> {
...
//	        })
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
            	...
            	GL11.glTranslatef(-0.175F, -1.15F, -3F);
        ...
        .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
            GL11.glTranslatef(-0.21F, -1.22F, -1.8F);
        ...
        .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
            GL11.glTranslatef(-0.295F, -1.23F, -0.5F);
        ...
        .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
        	GL11.glTranslatef(-0.177F, -1.27F, -0.9F);
        ...
        .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
            GL11.glTranslatef(-0.182F, -0.95F, -0.8F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
            GL11.glTranslatef(-0.065F, -1.07F, -1F);
        ...
        .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
        	GL11.glTranslatef(-0.065F, -1.04F, -1F);
            GL11.glScaled(0.45F, 0.45F, 0.45F);
        },(model) -> {
        if(model instanceof Reflex2) {
        ...
        .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
		    GL11.glTranslatef(-0.145F, -1.77F, -1.3F);
        ...
        .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                GL11.glTranslatef(-0.04F, -1.08F, -1.1F);
        ...
        .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                GL11.glTranslatef(-0.295F, -1.27F, -1.2F);
        ...
        .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                GL11.glTranslatef(-0.04F, -1.09F, -0.8F);
                GL11.glScaled(0.65F, 0.65F, 0.65F);
        },(model) -> {
            if(model instanceof Reflex2) {
        ...
        .withCompatibleAttachment(Attachments.Grip2, (model) -> {
            GL11.glTranslatef(-0.2F, -0.1F, -2.6F);
            GL11.glScaled(1F, 1F, 1F);
        })
        ...
        .withCompatibleAttachment(Attachments.Laser, (model) -> {
            GL11.glTranslatef(0.02F, -1.04F, -3.6F);
            GL11.glScaled(1F, 1F, 1F);
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.150000f, 0.700000f, -0.700000f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                GL11.glRotatef(6.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.150000f, 0.700000f, -0.400000f);
...
//           	 GL11.glRotatef(-10F, 1f, 0f, 0f);
            ...
            .withFirstPersonPositioningReloading(
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.700000f, 0.81f, -0.750000f);
                }, 100, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(-31.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.700000f, 0.87f, -0.750000f);
                }, 50, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.700000f, 0.84f, -0.750000f);
                }, 70, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(-32.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.700000f, 0.85f, -0.750000f);
                }, 80, 0),
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.UMP9Mag,
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0.6F, 2.4F, 1.2F);
                        GL11.glRotatef(-10F, 1f, 0f, 0f);
                    }, 250, 1000),
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.UMP9Mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
...
//                }, 100, 0)
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.59f, -0.6f);
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroReflex)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.283f, 1f);
                } 
                
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holographic)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.272f, 0.8f);
                } 
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.59f, -0.4f);
             ...
             // ACOG Zoom
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.21f, 0.75f);
                } 
...
//                GL11.glTranslatef(-0.150000f, 1.199999f, -0.225000f);
                ...
                GL11.glTranslatef(-000000f, 1.1f, -0.600000f);
             })
