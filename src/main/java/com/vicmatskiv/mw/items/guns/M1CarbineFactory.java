...
//          GL11.glScaled(0.55F, 0.55F, 0.55F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M1CarbineRearSight, true, (model) -> {
          ...
          GL11.glScaled(0.11F, 0.13F, 0.13F);
        })
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
		    ...
		    .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.875000f, 0.6f, 0.2f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                      ...
                      GL11.glTranslatef(0.275000f, 1.7f, 0.2f);
                  }, 350, 600)
                    )
			...
			.withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(0.000000f, 0f, 1f, 0f);
                GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.175000f, 1.125000f, -0.275000f);
			 })
			 .withFirstPersonPositioningModifying((renderContext) -> {
			     ...
			     GL11.glRotatef(-15.000000f, 0f, 0f, 1f);
			     GL11.glTranslatef(-0.700000f, 0.525000f, -0.250000f);
			 ...
			 .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                         GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.200000f, -0.175000f, 0.300000f);
                     }, 
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.350000f, -0.425000f, -0.025000f);
                     })
			...
			.withFirstPersonHandPositioningModifying(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.400000f, 0.025000f, 0.550000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(2.5f, 2.5f, 2.5f);
                         GL11.glRotatef(-120.000000f, 1f, 0f, 0f);
