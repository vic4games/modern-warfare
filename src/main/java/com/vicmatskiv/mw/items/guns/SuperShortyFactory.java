...
import com.vicmatskiv.mw.models.SuperShorty;
import com.vicmatskiv.weaponlib.Weapon;
import com.vicmatskiv.weaponlib.WeaponRenderer;
import com.vicmatskiv.weaponlib.animation.Transition;
import com.vicmatskiv.weaponlib.crafting.CraftingComplexity;

public class SuperShortyFactory implements GunFactory {

	public Item createGun(CommonProxy commonProxy) {
		return new Weapon.Builder()
		.withModId(ModernWarfareMod.MODID)
		.withName("SuperShorty")
//		.withAmmo(CommonProxy.Remington870Mag)
		...
		.withIteratedLoad()
		.withEjectSpentRoundSound("SuperShortyAction")
        .withPumpTimeout(700)
        .withFireRate(0.1f)
        .withRecoil(9f)
        .withZoom(0.9f)
        .withMaxShots(1)
        .withShootSound("supershorty")
        .withSilencedShootSound("ShotgunSilenced")
        .withReloadSound("drawweapon")
        .withReloadIterationSound("loadshell")
        .withAllReloadIterationsCompletedSound("SuperShortyAction")
		...
		.withCrafting(CraftingComplexity.MEDIUM, 
                ...
                Ores.INGOT_STEEL)
		.withInformationProvider(stack -> Arrays.asList("Type: Shotgun", "Damage per Pellet: 8", "Pellets per Shot: 10", 
		...
		.withCompatibleAttachment(AuxiliaryAttachments.SuperShortyAction, true, (model) -> {
//			GL11.glTranslatef(0F, 0F, 0.8F);
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withThirdPersonPositioning((renderContext) -> {
			    GL11.glScaled(0.5F, 0.5F, 0.5F);
                GL11.glTranslatef(-2.2F, 0F, 1.9F);
			...
			.withFirstPersonPositioningLoadIterationCompleted((renderContext) -> {
				...
				GL11.glTranslatef(-0.600000f, 2.074999f, -0.675000f);
                })
			...
			.withFirstPersonPositioning((renderContext) -> {
				...
				GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
				GL11.glTranslatef(-0.725000f, 1.699999f, -1.35f);
				})
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
				...
				GL11.glRotatef(5F, 0f, 0f, 1f);
				GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
				GL11.glTranslatef(-0.725000f, 1.699999f, -1f);
			...
			.withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
				GL11.glTranslatef(0.02f, 1.5f, -0.9f);
                GL11.glRotatef(-2.5F, 1f, 0f, 0f);
...
//              // Holo Zoom
			...
			.withFirstPersonCustomPositioning(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(), (renderContext) -> {
				})
				
			.withFirstPersonCustomPositioningLoadIterationCompleted(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(), (renderContext) -> {
                })
			...
			.withFirstPersonPositioningEjectSpentRound(
			        new Transition((renderContext) -> { // Reload position
						...
						GL11.glRotatef(30.000000f, 0f, 0f, 1f);
						GL11.glTranslatef(-0.725000f, 2.2f, -0.850000f);
	                }, 170, 0),
	                ...
	                new Transition((renderContext) -> { // Reload position
	    				...
	    				GL11.glTranslatef(-0.725000f, 2.2f, -0.6f);
	                }, 150, 0),
			...
			.withFirstPersonCustomPositioningEjectSpentRound(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(),
					new Transition((renderContext) -> { // Reload position
					}, 150, 50),
					new Transition((renderContext) -> { // Reload position
						GL11.glTranslatef(0F, 0F, 0.8F);
			...
			.withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(),
				new Transition((renderContext) -> { // Reload position
				}, 250, 50),
				new Transition((renderContext) -> { // Reload position
				}, 250, 50)
			...
			.withFirstPersonCustomPositioningAllLoadIterationsCompleted(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(),
                new Transition((renderContext) -> { // Reload position\
                }, 250, 50),
            ...
            .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.SuperShortyAction.getRenderablePart(),  
                new Transition((renderContext) -> { // Reload position
                }, 250, 50),
			...
			.withFirstPersonPositioningZooming((renderContext) -> {
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
				GL11.glTranslatef(0.02f, 1.5f, -1.1f);
...
//				// Holo Zoom
			...
			.withFirstPersonPositioningRunning((renderContext) -> {
				...
				GL11.glRotatef(30.000000f, 0f, 0f, 1f);
				GL11.glTranslatef(-0.425000f, 1.499999f, -0.250000f);
			 })
			 .withFirstPersonPositioningModifying((renderContext) -> {
			     ...
			     GL11.glTranslatef(-0.925000f, 1.224999f, -0.975000f);
			 }) 
			.withFirstPersonHandPositioning(
					 (renderContext) -> {
					     ...
					     GL11.glTranslatef(0.125000f, -0.250000f, 0.175000f);
					 }, 
					 (renderContext) -> {
						 GL11.glScalef(5f, 5f, 5f);
						 ...
						 GL11.glTranslatef(0.550000f, -0.600000f, 0.125000f);
					 })
            ...
            .withFirstPersonLeftHandPositioningAllLoadIterationsCompleted(
            		new Transition((renderContext) -> { // Reload position
					     ...
					     GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
					     GL11.glRotatef(30.000000f, 0f, 0f, 1f);
					     GL11.glTranslatef(0.100000f, -0.175000f, 0.025000f);
                    }, 250, 50),
			        ...
			        new Transition((renderContext) -> { // Reload position
			        	GL11.glScalef(5f, 5f, 5f);
					     ...
					     GL11.glRotatef(40.000000f, 0f, 0f, 1f);
					     GL11.glTranslatef(0.075000f, -0.425000f, 0.075000f);
                    }, 250, 50),
