...
//			GL11.glTranslatef(0f, 2.3f, -0.1f);
		})
		.withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
			if(model instanceof AKMiron1) {
				...
				GL11.glTranslatef(-0.17F, -1.35F, -4.9F);
				...
				GL11.glTranslatef(-0.145F, -1.38F, 0.385F);
		...
		.withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
			GL11.glTranslatef(-0.28F, -1.43F, -0.4F);
		...
		.withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
			GL11.glTranslatef(-0.17F, -1.15F, -0.55F);
		...
		.withCompatibleAttachment(Attachments.MicroT1, (model) -> {
            if(model instanceof MicroT1) {
                GL11.glTranslatef(-0.165F, -1.42F, -0.5F);
                GL11.glScaled(0.3F, 0.3F, 0.3F);
            } else if(model instanceof Reflex2) {
            	GL11.glTranslatef(-0.12F, -1.5F, -1F);
				GL11.glScaled(0.1F, 0.1F, 0.1F);
            }
        })
		.withCompatibleAttachment(Attachments.Scope, (player, stack) -> {
	    	
			GL11.glTranslatef(-0.31F, -1.43F, -0.4F);
		...
		.withCompatibleAttachment(Attachments.HP, (player, stack) -> {
			...
			GL11.glTranslatef(-0.31F, -1.43F, -0.7F);
			GL11.glScaled(0.8F, 0.8F, 0.8F);
		},(model) -> {
		...
		.withCompatibleAttachment(Attachments.Reflex, (model) -> {
			if(model instanceof Reflex) {
				GL11.glTranslatef(-0.075F, -1.26F, -0.5F);
                GL11.glScaled(0.35F, 0.35F, 0.35F);
			} else if(model instanceof Reflex2) {
				GL11.glTranslatef(-0.12F, -1.47F, -0.6F);
				GL11.glScaled(0.1F, 0.1F, 0.1F);
			}
		})
		.withCompatibleAttachment(Attachments.Kobra, (model) -> {
			if(model instanceof Kobra) {
				GL11.glTranslatef(-0.065F, -1.3F, -0.5F);
                GL11.glScaled(0.45F, 0.45F, 0.45F);
			} else if(model instanceof Reflex2) {
				GL11.glTranslatef(-0.12F, -1.47F, -1F);
				GL11.glScaled(0.1F, 0.1F, 0.1F);
			}
		})
		.withCompatibleAttachment(Attachments.Holo2, (model) -> {
			if(model instanceof Holographic) {
				...
				GL11.glTranslatef(-0.12F, -1.51F, -0.8F);
				GL11.glScaled(0.05F, 0.05F, 0.05F);
			}
		})
		...
		.withCompatibleAttachment(Attachments.RMR, (model) -> {
            if(model instanceof RMRsight) {
            	GL11.glTranslatef(-0.159F, -1.42F, -0.5F);
                GL11.glScaled(0.25F, 0.25F, 0.25F);
            } else if(model instanceof Reflex2) {
            	GL11.glTranslatef(-0.122F, -1.425F, -0.8F);
				GL11.glScaled(0.08F, 0.08F, 0.08F);
            }
        })
		.withCompatibleAttachment(Attachments.Silencer762x51, (model) -> {
			GL11.glTranslatef(-0.2F, -1.08F, -7F);
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
				...
				GL11.glTranslatef(-0.350000f, 1.100000f, -0.750000f);
...
//				GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
				...
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glRotatef(5.000000f, 0f, 0f, 1f);
				GL11.glTranslatef(-0.350000f, 1.100000f, -0.6f);
			...
			.withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
					...
					GL11.glTranslatef(0.29f, 1f, -1f);
					
					// ACOG Zoom
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
						//System.out.println("Position me for Acog");
						GL11.glTranslatef(0.005F, 0.18f, 1.25f);
					} 
					
					// ACOG Zoom
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
						//System.out.println("Position me for Acog");
						GL11.glTranslatef(-0.005F, 0.09f, 1.25f);
					} 
					
					// Scope Zoom
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Scope)) {
						//System.out.println("Position me for Scope");
						GL11.glTranslatef(0F, 0.22f, 1.05f);
					} 
					
					// Scope Zoom
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HP)) {
						//System.out.println("Position me for Scope");
						GL11.glTranslatef(0F, 0.22f, 0.95f);
					} 
					
					// Reflex Zoom
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
						//System.out.println("Position me for Reflex");
						GL11.glTranslatef(0F, 0.10f, 1f);
					} 
					// Reflex Zoom
					...
					if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
						//System.out.println("Position me for Holo");
						GL11.glTranslatef(0F, 0.13f, 1.4f);
					} 
			...
			.withFirstPersonPositioningReloading(
					...
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glTranslatef(-0.350000f, 1.100000f, -0.7f);
					}, 120, 20),
			...
			.withFirstPersonPositioningZooming((renderContext) -> {
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glScaled(4F, 4F, 4F);
				GL11.glTranslatef(0.29f, 1f, -1.1f);
				
				// ACOG Zoom
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
					//System.out.println("Position me for Acog");
					GL11.glTranslatef(0.005F, 0.18f, 1.3f);
				} 
				
				// ACOG Zoom
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
					//System.out.println("Position me for Acog");
					GL11.glTranslatef(-0.005F, 0.09f, 1.3f);
				} 
				
				// Scope Zoom
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Scope)) {
					//System.out.println("Position me for Scope");
					GL11.glTranslatef(0F, 0.22f, 1.1f);
				} 
			...
			.withFirstPersonPositioningRunning((renderContext) -> {
				...
				GL11.glTranslatef(-0.200000f, 1.324999f, -0.725000f);
			 })
			 .withFirstPersonPositioningModifying((renderContext) -> {
				 ...
				 GL11.glTranslatef(-0.800000f, 0.875000f, -0.775000f);
			 })
			 ...
			 .withFirstPersonHandPositioning(
					 (renderContext) -> {
						 ...
						 GL11.glRotatef(25.000000f, 0f, 0f, 1f);
						 GL11.glTranslatef(0.225000f, -0.050000f, 0.225000f);
					 }, 
					 (renderContext) -> {
						 GL11.glScalef(3.5f, 3.5f, 3.5f);
						 ...
						 GL11.glTranslatef(0.425000f, -0.450000f, 0.175000f);
					 })
			...
			.withFirstPersonHandPositioningModifying(
					 (renderContext) -> {
						 ...
						 GL11.glRotatef(20.000000f, 0f, 0f, 1f);
						 GL11.glTranslatef(0.125000f, -0.025000f, 0.500000f);
					 }, 
					 (renderContext) -> {
						 GL11.glScalef(3.5f, 3.5f, 3.5f);
						 GL11.glRotatef(-90.000000f, 1f, 0f, 0f);
			...
			.withFirstPersonLeftHandPositioningReloading(
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glTranslatef(0.500000f, -0.100000f, 0.575000f);
					}, 50, 200),
					...
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glRotatef(20.000000f, 0f, 0f, 1f);
						GL11.glTranslatef(0.175000f, -0.275000f, 0.450000f);
					}, 50, 200),
					...
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
						GL11.glRotatef(15.000000f, 0f, 0f, 1f);
						GL11.glTranslatef(0.150000f, -0.325000f, 0.375000f);
					}, 250, 0),
					...
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
						GL11.glRotatef(20.000000f, 0f, 0f, 1f);
						GL11.glTranslatef(0.100000f, -0.375000f, 0.200000f);
					}, 50, 200),
					...
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
						GL11.glRotatef(20.000000f, 0f, 0f, 1f);
						GL11.glTranslatef(-0.075000f, -0.600000f, 0.175000f);
					}, 50, 200),
