...
//		})
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.Mag10mm, (player, itemStack) -> {})
			
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.Mag10mm, (player, itemStack) -> {})
			...
			.withFirstPersonCustomPositioning(CommonProxy.Mag10mm, (player, itemStack) -> {})
			...
			.withFirstPersonCustomPositioningUnloading(CommonProxy.Mag10mm,
...
//					GL11.glScaled(0.55F, 0.55F, 0.55F);
			...
			.withFirstPersonCustomPositioningReloading(CommonProxy.Mag10mm,
				new Transition((player, itemStack) -> {
					GL11.glTranslatef(0.05F, 1.3F, 0.4F);
//					GL11.glRotatef(0F, 0f, 1f, 0f);
//					GL11.glScaled(0.55F, 0.55F, 0.55F);
