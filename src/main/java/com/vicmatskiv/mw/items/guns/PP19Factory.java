...
//      .withAmmoCapacity(30)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glScaled(0.35F, 0.35F, 0.55F);
            } else if(model instanceof AK47iron) {
                GL11.glTranslatef(-0.25F, -1.6F, -2.9F);
                GL11.glScaled(0.8F, 0.6F, 0.6F);
...
//      })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.500000f, 0.675000f, -0.650000f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                GL11.glRotatef(5.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.500000f, 0.675000f, -0.5f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                GL11.glTranslatef(0.350000f, 0.8f, -0.6f);
...
//              GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningReloading(
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-5.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.425000f, 1f, -0.6f);
                }, 250, 100),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(-5.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.425000f, 0.825000f, -0.6f);
                }, 200, 150),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    ...
                    GL11.glTranslatef(-0.475000f, 1.299999f, 0.125000f);
                }, 300, 200),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    ...
                    GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.475000f, 1.299999f, 0.15f);
                }, 130, 100),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glRotatef(-20.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonPositioningUnloading(
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(40.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(-5.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.425000f, 0.825000f, -0.175000f);
                }, 150, 50),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glRotatef(0.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.PP19Mag,
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.PP19Mag,
                new Transition((renderContext) -> {
                    GL11.glTranslatef(0F, 1F, 0F);
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.8f, -0.7f);
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
              ...
              .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.275000f, -0.225000f, 0.150000f);
                     }, 
                     (renderContext) -> {
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.250000f, -0.650000f, 0.575000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(70.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.250000f, -0.625000f, 0.050000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(5f, 5f, 5f);
                        GL11.glRotatef(-70.000000f, 1f, 0f, 0f);
