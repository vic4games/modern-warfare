...
//        .withShellCasingForwardOffset(-0.2f)
        ...
        "Rate of Fire: 60/100",
        "Magazines:",
        "30rnd 7.62x39mm Vulcan Magazine"))
...
//          GL11.glTranslatef(0F, 0F, 1F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.25F, -1.63F, -3.05F);
        ...
        .withCompatibleAttachment(Magazines.AKMVulcanMag, (model) -> {
//          GL11.glTranslatef(-0.35F, 0.5F, -1.25F);
//            GL11.glScaled(1.15F, 1.2F, 1.15F);
        })
        .withTextureNames("ak74vulcan")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new AK74Vulcan())
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                     ...
                     GL11.glTranslatef(-0.205000f, 0.885000f, -0.375000f);
...
//	                 GL11.glTranslatef(0.000000f, 1.399999f, 0.500000f);
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
	                ...
	                GL11.glTranslatef(-0.205000f, 0.905000f, 0.105000f);
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.AKMVulcanMag,
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.AKMVulcanMag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
...
//                    }, 500, 1000),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.35f, 0.76f, 0.1f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
            	GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.35f, 0.76f, 0.4f);
