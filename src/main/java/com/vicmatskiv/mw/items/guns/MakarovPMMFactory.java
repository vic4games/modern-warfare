...
//		.withAmmoCapacity(10)
		...
		.withInformationProvider(stack -> Arrays.asList("Damage: 10.8", 
...
//			GL11.glScaled(0.55F, 0.55F, 0.55F);
		...
		.withTextureNames("MakarovPMM", "Electric")
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.MakarovTop.getRenderablePart(), (player, itemStack) -> {
...
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
			...
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.MakarovTop.getRenderablePart(), (player, itemStack) -> {
				GL11.glTranslatef(0F, 0F, 0.5F);
//				GL11.glRotatef(45F, 0f, 1f, 0f);
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
				})
				
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.Magazine9mm, (player, itemStack) -> {})
			
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.Magazine9mm, (player, itemStack) -> {})
			...
			.withFirstPersonCustomPositioning(CommonProxy.Magazine9mm, (player, itemStack) -> {})
			
			.withFirstPersonCustomPositioning(CommonProxy.MakarovTop.getRenderablePart(), (player, itemStack) -> {
