...
public class RAS47Factory implements GunFactory {
...
//		.withAmmoCapacity(30)
		...
		"Caliber: 7.62x39mm", "Magazines:", "32rnd 7.62x39mm Magazine", "30rnd 7.62x39mm PMAG Magazine",
		"Fire Rate: Auto"))
		...
		.withCompatibleAttachment(CommonProxy.Silencer762x39, (model) -> {
			GL11.glTranslatef(0.107F, -1.25F, -4.65F);
			GL11.glScaled(1F, 1F, 1F);
		})
		.withTextureNames("RAS47", "Electric")
...
//				GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonPositioningShooting((renderContext) -> {
