        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.25f, 1.25f, -0.35f);
                    }, 280, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.3f, 1.25f, -0.35f);
                    }, 270, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.4f, 1.25f, -0.35f);
                    }, 240, 0),
                    new Transition((renderContext) -> { // Reload position
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.2f, 1.25f, -0.35f);
                    }, 260, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(-13F, 1f, 0f, 0f);
                        GL11.glRotatef(44F, 0f, 1f, 0f);
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.2f, 1.2f, -0.35f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
             ...
             // Standard Iron Sight Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    ...
                    GL11.glTranslatef(0F, 0.02f, 0.25f);
                } 
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
             ...
             // Standard Iron Sight Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.02f, 0.15f);
                } 
