...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Glock19slide, true, (model) -> {
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Glock19slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.7F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Glock19slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.7F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.Glock19slide.getRenderablePart(), (renderContext) -> {
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Glock19slide.getRenderablePart(),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.Glock19slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Glock19slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.Glock19slide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
