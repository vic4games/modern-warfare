...
//            GL11.glRotatef(-35F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M392Mag, true, (model) -> {
...
//            GL11.glScaled(0.75F, 1F, 1F);
        ...
        .withCompatibleAttachment(Attachments.DMRScope, true, (player, stack) -> {
            GL11.glTranslatef(-0.21F, -2.13F, -1F);
            GL11.glScaled(0.75F, 0.75F, 0.75F);
        },(model) -> {
            if(model instanceof DMRscopeReticle) {
                GL11.glTranslatef(0.12F, -0.08F, 0.2F);
                GL11.glScaled(0.03F, 0.03F, 0.03F);
            }
        })
        .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
            GL11.glTranslatef(-0.21F, -2.11F, -2.6F);
            GL11.glScaled(0.75F, 0.75F, 0.75F);
        },(model) -> {
        ...
        .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                GL11.glTranslatef(-0.177F, -2.13F, -1.5F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
            GL11.glTranslatef(-0.066F, -1.95F, -1.8F);
...
//                GL11.glTranslatef(-1.224999f, 1.224999f, -2.124999f);
                })
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M392Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.M392Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(18.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.224999f, 1.224999f, -2f);
                    }, 300, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(15.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.224999f, 1.224999f, -1.9f);
                    }, 250, 0),
            ...
            new Transition((renderContext) -> { // Reload position
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.45f, 1.4f, -1.15f);
                ...
                new Transition((renderContext) -> { // Reload position
                    GL11.glRotatef(40F, 0f, 1f, 0f);
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glTranslatef(-0.45f, 1.4f, -1.1f);
                    GL11.glRotatef(-5F, 0f, 0f, 1f);
                    GL11.glRotatef(-5F, 1f, 0f, 0f);
                }, 180, 0)
            )
                    
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M392Action.getRenderablePart(),
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M392Mag.getRenderablePart(),
                    new Transition((renderContext) -> {
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M392Mag.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M392Action.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.425000f, 1.6f, -1.4f);
                        GL11.glRotatef(10.000000f, 1f, 0f, 0f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-4.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.425000f, 1.5f, -1.4f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-4.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.425000f, 1.4f, -1.2f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-4.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.425000f, 1.4f, -1.05f);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.M392Action.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.03f, 1.1f);
                } 
                
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.02f, 1.3f);
                } 
...
//                         GL11.glScalef(4.5f, 4.5f, 4.5f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(15.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.225000f, -1.249999f, 0.200000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(0.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.325000f, -1.249999f, 0.200000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(0.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.425000f, -1.599999f, 0.200000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.050000f, -1.249999f, 0.200000f);
                    }, 50, 200),
...
//                    }, 250, 1000),
            ...
            .withFirstPersonLeftHandPositioningDrawing(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(45.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.250000f, -0.650000f, -0.025000f);
                    }, 250, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-25.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(55.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.450000f, -0.750000f, -0.050000f);
                    }, 250, 0),
