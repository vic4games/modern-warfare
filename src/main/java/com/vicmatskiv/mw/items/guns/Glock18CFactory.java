...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Glock18Cslide, true, (model) -> {
            if(model instanceof Glock18Cslide) {
                GL11.glScaled(1F, 1F, 1F);
//                GL11.glTranslatef(0F, 0F, 0.5F);
            }
            else if(model instanceof GlockRearSight) {
                GL11.glTranslatef(-0.152F, -1.165F, -0.05F);
                GL11.glScaled(0.27F, 0.2F, 0.4F);
            }
            else if(model instanceof M1911frontsight) {
                GL11.glTranslatef(-0.152F, -1.14F, -2.05F);
                GL11.glScaled(0.27F, 0.24F, 0.16F);
            }
        })
...
//            GL11.glTranslatef(-0.185F, -0.23F, -3.5F);
        ...
        .withCompatibleAttachment(Attachments.Silencer9mm, (model) -> {
            GL11.glTranslatef(-0.23F, -1.14F, -4.6F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                if(activeAttachment == Attachments.GlockStock) {
                    ...
                    GL11.glTranslatef(-0.300000f, 0.800000f, -2.3f);
                } else {
                    GL11.glScaled(2F, 2F, 2F);
                    GL11.glRotatef(45F, 0f, 1f, 0f);
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.7F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.7F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(), (renderContext) -> {
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.75f, 0.65f, -2f);
                    }, 300, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-6F, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.8f, 0.65f, -2f);
                    }, 200, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-3F, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.7f, 0.65f, -2f);
                    }, 70, 0)
                )
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(4F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.29f, 1.3f, -1.8f);
                    }, 100, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(40F, 0f, 1f, 0f);
                        ...
                        GL11.glTranslatef(-0.29f, 1f, -1.8f);
                    }, 90, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(42F, 0f, 1f, 0f);
                        GL11.glRotatef(4F, 0f, 0f, 1f);
                        GL11.glRotatef(-2F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.29f, 0.65f, -1.8f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(43F, 0f, 1f, 0f);
                        ...
                        GL11.glTranslatef(-0.29f, 0.68f, -1.75f);
                    }, 130, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.Glock18Cslide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                if(activeAttachment == Attachments.GlockStock) {
                    GL11.glRotatef(45F, 0f, 1f, 0f);
                    GL11.glScaled(3F, 3F, 3F);
                    GL11.glTranslatef(0.350000f, 0.62f, -1.8f);
                    ...
                    GL11.glRotatef(45F, 0f, 1f, 0f);
                    GL11.glScaled(3F, 3F, 3F);
                    GL11.glTranslatef(0.32f, 0.68f, -1.9f);
                    GL11.glRotatef(-3F, 1f, 0f, 0f);
                    GL11.glRotatef(2F, 0f, 0f, 1f);
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         if(activeAttachment == Attachments.GlockStock) {
                             ...
                             GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                             GL11.glTranslatef(-0.025000f, -0.825000f, 0.125000f);
                         } else {
                             GL11.glScalef(4.500000f, 4.500000f, 4.500000f);
...
//                       GL11.glScalef(4.500000f, 4.500000f, 4.500000f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-60.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.175000f, -0.925000f, 0.250000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-60.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.175000f, -0.65f, 0.2f);
                    }, 50, 200),
