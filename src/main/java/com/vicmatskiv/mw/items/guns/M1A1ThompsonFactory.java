    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        "Magazines:",
         ...
         .withCrafting(CraftingComplexity.MEDIUM,
                Ores.PlasticPlate,
                Ores.GunmetalPlate)
        .withCompatibleAttachment(AuxiliaryAttachments.M1A1ThompsonAction, true, (model) -> {
//            GL11.glTranslatef(0.45F, -0.15F, 0.65F);
//            GL11.glRotatef(-25F, 0f, 0f, 1f);
        })
        .withCompatibleAttachment(AuxiliaryAttachments.M1A1Sight, true, (model) -> {
...
//            GL11.glTranslatef(0.45F, 1.9F, 0F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.05F, -0.79F, -3.4F);
...
//                GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.M1A1ThompsonAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.M1A1ThompsonAction.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.M1A1ThompsonAction.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.M1A1ThompsonAction.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.317f, 0.283f, -2f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.314f, 0.3f, -1.9f);
                GL11.glRotatef(0.1F, 1f, 0f, 0f);
                GL11.glRotatef(0.5F, 0f, 0f, 1f);
