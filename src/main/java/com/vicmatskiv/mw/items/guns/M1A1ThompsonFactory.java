        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.3f, 0.6f, -1.3f);
                    }, 280, 50),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.325000f, 1.000000f, -1.000000f);
                }, 310, 55),
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.325000f, 0.900000f, -1.549999f);
             })
            ...
            .withFirstPersonHandPositioningZooming(
                    (renderContext) -> {
                        GL11.glScalef(3.8f, 3.8f, 5f);
                        GL11.glRotatef(-35.000000f, 1f, 0f, 0f);
                        GL11.glRotatef(-50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(80.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.15f, -0.55f, -0.13f);
                    }, 
                    (renderContext) -> {
                        GL11.glScalef(3.8f, 3.8f, 3.8f);
                        GL11.glRotatef(-85.000000f, 1f, 0f, 0f);
