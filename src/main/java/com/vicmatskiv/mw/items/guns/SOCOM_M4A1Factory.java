...
public class SOCOM_M4A1Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        "Rate of Fire: 80/100",
        "Magazines:",
        "30rnd 5.56x45mm NATO SOCOM STANAG Magazine"))
...
//        })
        .withCompatibleAttachment(Attachments.SOCOM_Stock, true, (model) -> {
        ...
        .withCompatibleAttachment(Attachments.Block2SOCOMHandguard, true, (model) -> {
        ...
        .withCompatibleAttachment(Attachments.SOCOM_Grip, true, (model) -> {
...
//        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.175000f, 1.174999f, -0.725000f);
...
//                GL11.glTranslatef(-0.625000f, 1.0f, -0.600000f);
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(4F, 0f, 0f, 1f);
                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                GL11.glTranslatef(-0.175000f, 1.174999f, -0.325000f);
...
//              GL11.glTranslatef(0f, 0f, 0.5f);
            ...
            .withFirstPersonCustomPositioning(Magazines.SOCOM_Mag, (renderContext) -> {
