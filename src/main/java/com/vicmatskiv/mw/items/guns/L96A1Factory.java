...
public class L96A1Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
            GL11.glTranslatef(-0.215F, -1.45F, -2.2F);
...
//        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.23f, 1.174999f, -0.3f);
                
//                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
//                GL11.glRotatef(35F, 0f, 1f, 0f);
//                GL11.glRotatef(25f, 0f, 0f, 1f);
//                GL11.glTranslatef(-0.23f, 1.3f, -0.2f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glRotatef(5f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.23f, 1.174999f, -0.1f);
            ...
            .withFirstPersonPositioningEjectSpentRound(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.23f, 1.4f, -0.2f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(37F, 0f, 1f, 0f);
                        GL11.glRotatef(23f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.23f, 1.44f, -0.1f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(35F, 0f, 1f, 0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(23f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.23f, 1.42f, -0.15f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
...
//                        GL11.glScaled(0.4F, 0.4F, 0.6F);
            ...
            .withFirstPersonPositioningEjectSpentRoundAimed(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(12f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.3f, 1.04f, 0.4f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(13f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.3f, 1.044f, 0.4f);
                    }, 160, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(12f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.3f, 1.02f, 0.45f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
...
//                        GL11.glScaled(0.4F, 0.4F, 0.6F);
            ...
            .withFirstPersonCustomPositioningEjectSpentRound(Magazines.L96A1Mag,
                    new Transition((renderContext) -> { // Reload position
...
//                      GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
             ...
             .withFirstPersonPositioningReloading(
                     new Transition((renderContext) -> { // Reload position
                         ...
                         GL11.glTranslatef(-0.3f, 1.174999f, -0.3f);
                     }, 500, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(3f, 0f, 0f, 1f);
                        GL11.glRotatef(-3f, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.3f, 1.174999f, -0.1f);
                    }, 180, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(2f, 0f, 0f, 1f);
                        GL11.glRotatef(-2f, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.3f, 1.174999f, -0.2f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                        GL11.glRotatef(45F, 0f, 1f, 0f);
            ...
            .withFirstPersonPositioningUnloading(
                     ...
                     new Transition((renderContext) -> { // Reload position
                         ...
                         GL11.glRotatef(0f, 0f, 0f, 1f);
                         GL11.glRotatef(3f, 1f, 0f, 0f);
                         GL11.glTranslatef(-0.3f, 1.15f, -0.3f);
                     }, 240, 0))
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.125000f, 1.4f, 0.750000f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(35F, 0f, 1f, 0f);
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(18F, 0f, 0f, 1f);
                        GL11.glRotatef(2F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.125000f, 1.2f, 0.6f);
                    }, 230, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        ...
                        GL11.glRotatef(3F, 1f, 0f, 0f);
                        GL11.glTranslatef(-0.125000f, 0.875000f, 0.3f);
                    }, 300, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(9F, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.125000f, 0.88f, 0f);
                        GL11.glRotatef(1F, 1f, 0f, 0f);
                    }, 250, 0)
                    )
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
             ...
             // HP Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.AKMIron)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(0.002F, 0.18f, 1f);
                } 
