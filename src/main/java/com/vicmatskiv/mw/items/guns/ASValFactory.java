...
//      .withAmmoCapacity(30)
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.23F, -1.56F, -4F);
                GL11.glScaled(0.7F, 0.85F, 0.7F);
...
//                GL11.glTranslatef(0.925000f, 1.249999f, 0.450000f);
                })
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                GL11.glTranslatef(0.350000f, 0.675000f, -000000f);
           ...
           .withFirstPersonCustomPositioning(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(), (renderContext) -> {
            ...
            .withFirstPersonPositioningReloading(
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.325000f, 0.575000f, 0.250000f);
                }, 400, 100),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                    ...
                    GL11.glRotatef(25.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(5.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(-0.325000f, 0.575000f, 0.27f);
                }, 120, 100),
                new Transition((renderContext) -> { // Reload position
                    GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
...
//                  GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
           ...
           .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(),
                new Transition((renderContext) -> {
                }, 500, 1000),
                new Transition((renderContext) -> {
                }, 500, 1000)
           ...
           .withFirstPersonPositioningInspecting(
                ...
                new Transition((renderContext) -> {
                    ...
                    GL11.glTranslatef(0.925000f, 1.249999f, 0.455f);
                }, 450, 400),
                new Transition((renderContext) -> {
                    GL11.glScaled(3F, 3F, 3F);
                    GL11.glRotatef(-51.000000f, 1f, 0f, 0f);
                    GL11.glRotatef(31.000000f, 0f, 1f, 0f);
                    GL11.glRotatef(54.000000f, 0f, 0f, 1f);
                    GL11.glTranslatef(0.925000f, 1.249999f, 0.450000f);
                }, 350, 0)
                    )
                    
           .withFirstPersonCustomPositioningInspecting(AuxiliaryAttachments.VSSVintorezAction.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 300, 600),
                  new Transition((renderContext) -> {
                  }, 350, 600),
           ...
           .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.675000f, -0.200000f);

                // Scope Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.PSO1)) {
                    //System.out.println("Position me for Scope");
                    GL11.glTranslatef(-0.015F, 0.273f, 0f);
                }   
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.250000f, 1.249999f, -0.750000f);
             })
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glRotatef(5.000000f, 0f, 1f, 0f);
                 GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                 GL11.glTranslatef(-0.600000f, 0.675000f, -0.575000f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(0.225000f, -0.250000f, 0.250000f);
                     }, 
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(-55.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.400000f, -0.450000f, 0.200000f);
                     })
            ...
            .withFirstPersonHandPositioningModifying(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.125000f, -0.050000f, 0.525000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(3.5f, 3.5f, 4.5f);
                         GL11.glRotatef(-95.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonRightHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(5.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(-40.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.200000f, -0.125000f, -0.075000f);
                    }, 260, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.5f, 3.5f, 4f);
                        GL11.glRotatef(-100.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glTranslatef(0.100000f, -0.350000f, -0.050000f);
                    }, 250, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.5f, 3.5f, 4f);
                        GL11.glRotatef(-100.000000f, 1f, 0f, 0f);
            ...
            .withFirstPersonRightHandPositioningInspecting(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(-90.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.100000f, -0.325000f, 0.000000f);
                    }, 250, 50),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.5f, 3.5f, 4.5f);
                        GL11.glRotatef(-60.000000f, 1f, 0f, 0f);
