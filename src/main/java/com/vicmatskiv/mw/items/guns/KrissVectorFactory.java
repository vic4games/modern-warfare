...
//		.withAmmoCapacity(30)
		...
		.withCompatibleAttachment(Attachments.Silencer45ACP, (model) -> {
			GL11.glTranslatef(-0.245F, -0.47F, -6.5F);
			GL11.glScaled(1.5F, 1.5F, 1.5F);
		})
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
			    ...
			    GL11.glTranslatef(-0.550000f, 0.675000f, -1.6f);
			    
//			    GL11.glRotatef(45F, 0f, 1f, 0f);
//                GL11.glScaled(2F, 2F, 2F);
//                GL11.glRotatef(5.000000f, 0f, 0f, 1f);
//                GL11.glTranslatef(-1.5f, 0.675000f, -3f);
				})
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScaled(2F, 2F, 2F);
                GL11.glRotatef(5.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.550000f, 0.675000f, -1.4f);
			...
			.withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                GL11.glTranslatef(0.287f, 1.04f, -1f);
...
//				GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonPositioningReloading(
				...
				new Transition((renderContext) -> { // Reload position
	                ...
	                GL11.glTranslatef(-0.675000f, 0.475000f, -1.4f);
				}, 270, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.550000f, 0.675000f, -1.3f);
                }, 180, 0)
			)
...
//					GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
		    ...
		    .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glTranslatef(-1.5f, 0.6f, -0.7f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                      GL11.glRotatef(-10.000000f, 1f, 0f, 0f);
                      ...
                      GL11.glTranslatef(0.5f, 1.2f, -1.2f);
                  }, 350, 600)
                    )
			...
			.withFirstPersonPositioningZooming((renderContext) -> {
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glScaled(4F, 4F, 4F);
				GL11.glTranslatef(0.287f, 1.04f, -1.1f);
			...
			.withFirstPersonPositioningRunning((renderContext) -> {
			 ...
			 .withFirstPersonPositioningModifying((renderContext) -> {
			    ...
			    GL11.glRotatef(-20.000000f, 0f, 0f, 1f);
			    GL11.glTranslatef(-0.500000f, -0.000000f, -0.925000f);
			 })
			 ...
			 .withFirstPersonHandPositioning(
					 (renderContext) -> {
					     ...
					     GL11.glTranslatef(0.2f, -0.43f, 0.2f);
					 }, 
					 (renderContext) -> {
			...
			.withFirstPersonHandPositioningModifying(
					 (renderContext) -> {
						 ...
						 GL11.glTranslatef(0.200000f, 0.050000f, 0.375000f);
					 }, 
					 (renderContext) -> {
					     GL11.glScalef(4f, 4f, 4f);
                         GL11.glRotatef(-100.000000f, 1f, 0f, 0f);
			...
			.withFirstPersonLeftHandPositioningReloading(
					new Transition((renderContext) -> { // Reload position
						...
						GL11.glTranslatef(0.350000f, -0.700000f, 0.200000f);
					}, 50, 200),
					...
					new Transition((renderContext) -> { // Reload position
					    ...
					    GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
					    GL11.glRotatef(60.000000f, 0f, 0f, 1f);
					    GL11.glTranslatef(0.200000f, -0.725000f, 0.250000f);
					}, 50, 200),
					...
					new Transition((renderContext) -> { // Reload position
					    ...
					    GL11.glTranslatef(0.100000f, -0.700000f, 0.325000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(5f, 5f, 5f);
                        GL11.glRotatef(-115.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glRotatef(45.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.025000f, -0.750000f, 0.225000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(5f, 5f, 5f);
                        GL11.glRotatef(-115.000000f, 1f, 0f, 0f);
