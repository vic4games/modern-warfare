    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.M4FrontSight, true, (model) -> {
            if(model instanceof M4Iron2) {
                GL11.glTranslatef(-0.055F, -1.35F, -5.1F);
                GL11.glScaled(0.8F, 0.68F, 1F);
          } else if(model instanceof FALIron) {
                  GL11.glTranslatef(-0.185F, -1.53F, -5.1F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning(
                    (renderContext) -> {
                        ...
                        if(activeAttachment == Attachments.Bipod) {
                            ...
                            GL11.glTranslatef(-0.12f, 1.2f, -0.4f);
                    } else {
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glRotatef(4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.1f, 1.15f, -0.6f);
                    }
                })
            ...
            .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.25f, 1.15f, -0.6f);
                    }, 280, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.3f, 1.15f, -0.6f);
                    }, 270, 0),
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-6F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.2f, 1.1f, -0.6f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
