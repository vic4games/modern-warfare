...
//		.withAmmoCapacity(30)
//		.withShellCasingModel(new Bullet44())
//		.withShellCasingModelTexture("Bullet")
		...
		.withCompatibleAttachment(CommonProxy.Grip2, (model) -> {
			GL11.glTranslatef(.135F, -0.73F, -2F);
			GL11.glScaled(0.8F, 0.8F, 0.8F);
		})
		...
		.withCompatibleAttachment(CommonProxy.Grip, (model) -> {
			GL11.glTranslatef(.135F, -0.65F, -2.3F);
			GL11.glScaled(0.8F, 0.8F, 0.8F);
		})
		...
		.withCompatibleAttachment(CommonProxy.Laser2, (p, s) -> {
			GL11.glTranslatef(.3F, -1.4F, -2.3F);
			GL11.glScaled(0.8F, 0.8F, 0.8F);
		})
		...
		.withCompatibleAttachment(CommonProxy.Silencer556x45, (model) -> {
			GL11.glTranslatef(0.107F, -1.5F, -5.4F);
