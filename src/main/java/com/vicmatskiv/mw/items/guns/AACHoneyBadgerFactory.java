...
public class AACHoneyBadgerFactory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withReloadSound("aac_honeybadger_reload")
...
//              GL11.glScaled(0F, 0F, 0F);
         ...
         .withCompatibleAttachment(Attachments.AKMIron, true, (model) -> {
            if(model instanceof M4Iron1) {
                ...
                GL11.glTranslatef(-0.17F, -1.48F, -3.13F);
                GL11.glScaled(0.55F, 0.55F, 1F);
            } else if(model instanceof AK47iron) {
                GL11.glTranslatef(-0.22F, -1.8F, -3.1F);
                ...
                GL11.glTranslatef(-0.09F, -1.32F, -3.1F);
                ...
                GL11.glTranslatef(-0.181F, -1.55F, -0.3F);
                GL11.glScaled(0.55F, 0.5F, 0.55F);
            }
        })
        .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
            GL11.glTranslatef(-0.21F, -1.42F, -1.7F);
        ...
        .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                GL11.glTranslatef(-0.041F, -1.28F, -0.7F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.AACRail, true, (model) -> {
            if(model instanceof AKRail) {
                ...
                GL11.glTranslatef(-0.03F, -0.8F, -3.4F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.225000f, 1.174999f, -0.700000f);
                
//                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
//                GL11.glRotatef(-10.000000f, 1f, 0f, 0f);
//                GL11.glRotatef(45.000000f, 0f, 1f, 0f);
//                GL11.glRotatef(75.000000f, 0f, 0f, 1f);
//                GL11.glTranslatef(0.250000f, 1.399999f, -0.500000f);
                })
            ...
            .withFirstPersonPositioningProning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.2f, 0.6f, -0.2f);
                })
            ...
            .withFirstPersonPositioningProningRecoiled((renderContext) -> {
                ...
                GL11.glTranslatef(-0.22f, 0.6f, -0.1f);
...
//              GL11.glTranslatef(0f, 0f, 0.5f);
            ...
            .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.35f, 1.1f, -0.65f);
                    }, 280, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.48f, 1.03f, -0.65f);
                    }, 270, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.45f, 0.98f, -0.65f);
                    }, 240, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(-5F, 1f, 0f, 0f);
                        GL11.glRotatef(42F, 0f, 1f, 0f);
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.4f, 1f, -0.65f);
                    }, 220, 170),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glRotatef(-10.000000f, 1f, 0f, 0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(75.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.350000f, 1.399999f, -0.500000f);
                    }, 300, 0)
                    )
            ...
            .withFirstPersonPositioningUnloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.4f, 1.15f, -0.65f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(-1F, 1f, 0f, 0f);
                        GL11.glRotatef(41F, 0f, 1f, 0f);
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.4f, 1.2f, -0.65f);
                    }, 220, 0),
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.35f, 1.25f, -0.65f);
                    }, 200, 0),
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-4F, 0f, 0f, 1f);
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.35f, 1.2f, -0.65f);
                    }, 230, 0)
                    )
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.150000f, 1.4f, -0.500000f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         if(activeAttachment == Attachments.Grip2 ||
                             ...
                             GL11.glRotatef(-40.000000f, 0f, 1f, 0f);
                             GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                             GL11.glTranslatef(0.275000f, -0.100000f, 0.250000f);
                         }
                     }, 
                     (renderContext) -> {
