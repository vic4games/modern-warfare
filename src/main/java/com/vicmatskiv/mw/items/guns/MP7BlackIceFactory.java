...
import com.vicmatskiv.mw.models.MP7BlackIce;
import com.vicmatskiv.mw.models.MP7FrontSights;
import com.vicmatskiv.mw.models.MP7Rail;
...
public class MP7BlackIceFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
        .withModId(ModernWarfareMod.MODID)
        .withName("mp7_black_ice")
        .withFireRate(0.9f)
        .withRecoil(1f)
        .withZoom(0.9f)
...
//            GL11.glTranslatef(-2.75F, 2.6F, 0F);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MP7Rail, true, (model) -> {
            if(model instanceof MP7Rail) {
        ...
        .withTextureNames("mp7blackice")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new MP7BlackIce())
...
//                         GL11.glTranslatef(-0.100000f, -0.675000f, 0.130000f);
                         ...
                         GL11.glRotatef(-35.000000f, 0f, 1f, 0f);
                         GL11.glRotatef(40.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(-0.025000f, -0.625000f, 0.175000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(6.5f, 6.5f, 6.5f);
