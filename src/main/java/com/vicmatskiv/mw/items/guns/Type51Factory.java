...
import com.vicmatskiv.mw.models.Type51;
...
public class Type51Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withMaxShots(1)
        //.withMaxShots(5)
        .withShootSound("type51")
        .withReloadSound("type51_reload")
        ...
        .withFlashTexture("flashes_type51")
        .withShellCasingEjectEnabled(false)
        .withCreativeTab(ModernWarfareMod.AssaultRiflesTab)
        .withInformationProvider(stack -> Arrays.asList(
        "Type: Covenant Carbine",
        "Damage: 14", 
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Type51Mag, true, (model) -> {
        })
        .withCompatibleAttachment(AuxiliaryAttachments.Type51Action, true, (model) -> {
        })
        .withTextureNames("type51")
        .withRenderer(new WeaponRenderer.Builder()
            .withModId(ModernWarfareMod.MODID)
            .withModel(new Type51())
            ...
            .withThirdPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-2.1F, -1.1F, 2.3F);
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.350000f, 1.274999f, 0.000000f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2f, 2f, 2f);
                GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.350000f, 1.274999f, 0.2f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Type51Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Type51Action.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, 0f, 1f);
                })
            ...
            .withFirstPersonPositioningReloading(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.5f, 0.000000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.4f, 0.000000f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.350000f, 1.3f, 0.000000f);
...
//                }, 100, 0)
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Type51Action.getRenderablePart(),
...
//                    }, 500, 1000),
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Type51Mag.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, -0.4F, 2F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, -0.4F, 2F);
                    }, 250, 1000),
...
//                        GL11.glRotatef(-10F, 0f, 1f, 0f);
            ...
            .withFirstPersonPositioningInspecting(
                  ...
                  new Transition((renderContext) -> {
                      ...
                      GL11.glTranslatef(0.2f, 1.9f, 0.2f);
                  }, 350, 600)
                    )
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Type51Mag.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.Type51Action.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.574999f, 0.000000f);
                        GL11.glRotatef(15.000000f, 1f, 0f, 0f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.474999f, 0.000000f);
                        GL11.glRotatef(10.000000f, 1f, 0f, 0f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(-2.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.374999f, 0.000000f);
                        GL11.glRotatef(-5.000000f, 1f, 0f, 0f);
                    }, 190, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(44F, 0f, 1f, 0f);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.Type51Action.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(-0.15f, 1.6f, 0.2f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(-0.15f, 1.6f, 0.35f);
                GL11.glRotatef(-5F, 0f, 0f, 1f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(0.075000f, 0.7f, 0.775000f);
             })
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glRotatef(0.000000f, 0f, 1f, 0f);
                 GL11.glRotatef(-20.000000f, 0f, 0f, 1f);
                 GL11.glTranslatef(-0.7f, 0.7f, -0.3f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.350000f, -0.225000f, 0.300000f);
                     }, 
                     (renderContext) -> {
...
//                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.050000f, -0.450000f, 0.025000f);
                    }, 50, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.225000f, -0.450000f, -0.075000f);
                    }, 250, 0),
