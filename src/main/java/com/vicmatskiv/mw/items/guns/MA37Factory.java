...
//            GL11.glRotatef(-35F, 1f, 0f, 0f);
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.MA37Mag, true, (model) -> {
...
//                GL11.glTranslatef(0f, 0f, 1f);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.MA37Mag.getRenderablePart(),
                    new Transition((renderContext) -> {
...
//                }, 100, 0)
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.MA37Mag.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.MA37Action.getRenderablePart(),
//                    new Transition((renderContext) -> {
//                    }, 500, 1000),
                    new Transition((renderContext) -> {
                    }, 500, 1000),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-4.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 1.1f, -0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                        GL11.glRotatef(-4.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, 0.95f, 0.05f);
                        GL11.glRotatef(-5.000000f, 1f, 0f, 0f);
                    }, 190, 100),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.MA37Action.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
