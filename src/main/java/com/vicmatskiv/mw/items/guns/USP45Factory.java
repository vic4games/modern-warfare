...
//			GL11.glScaled(0.55F, 0.55F, 0.55F);
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioningCustomRecoiled(CommonProxy.USP45Top.getRenderablePart(), (player, itemStack) -> {
...
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
			...
			.withFirstPersonPositioningCustomZoomingRecoiled(CommonProxy.USP45Top.getRenderablePart(), (player, itemStack) -> {
				GL11.glTranslatef(0F, 0F, 0.5F);
//				GL11.glRotatef(45F, 0f, 1f, 0f);
//				GL11.glScaled(0.55F, 0.55F, 0.55F);
				})
