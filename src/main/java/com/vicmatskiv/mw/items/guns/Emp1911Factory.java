...
public class Emp1911Factory implements GunFactory {
...
//      .withShellCasingForwardOffset(0.001f)
        ...
        .withInformationProvider(stack -> Arrays.asList("Type: Pistol", "Damage: 8.5", 
        "Caliber: .45 ACP", "Magazines:", "7rnd .45 ACP Magazine",
        "Fire Rate: Semi"))
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Emp1911Slide, true, (model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.Emp1911Slide.getRenderablePart(), (renderContext) -> {
...
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.Emp1911Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.5F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
...
//                    GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.Emp1911Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                    }, 250, 1000)
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.Emp1911Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScaled(3F, 3F, 3F);
                GL11.glTranslatef(0.350000f, 0.64f, -2.5f);
...
//                       GL11.glScalef(0f, 0f, 0f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(45.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.350000f, -0.750000f, -0.025000f);
                    }, 250, 0))
