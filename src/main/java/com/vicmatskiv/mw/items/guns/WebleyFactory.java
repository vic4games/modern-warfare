...
//      .withAmmo(CommonProxy.Remington870Mag)
        ...
        .withCrafting(CraftingComplexity.MEDIUM, 
                ...
                Ores.INGOT_STEEL)
       .withInformationProvider(stack -> Arrays.asList("Type: Service Revolver", "Damage: 9", 
...
//              // Holo Zoom
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.8f, -0f, -1.249999f);
             })
            ...
            .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glTranslatef(-0.100000f, -0.850000f, 0.100000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(7f, 7f, 7f);
                         ...
                         GL11.glTranslatef(0.400000f, -0.550000f, 0.225000f);
                     })
