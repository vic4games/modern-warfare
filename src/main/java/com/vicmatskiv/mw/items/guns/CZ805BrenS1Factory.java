...
public class CZ805BrenS1Factory implements GunFactory {

    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
        .withModId(ModernWarfareMod.MODID)
        .withName("cz805_bren_s1")
        //.withAmmoCapacity(30)
        .withFireRate(0.75f)
        .withRecoil(3f)
        .withZoom(0.9f)
...
//          GL11.glTranslatef(0F, 0F, 0.75F);
        ...
        .withCompatibleAttachment(Attachments.Grip2, true, (model) -> {
            GL11.glTranslatef(-0.07F, 0.22F, -2F);
            GL11.glScaled(0.8F, 0.8F, 0.8F);
        })
        .withCompatibleAttachment(Attachments.Reflex, true, (player, stack) -> {
            GL11.glTranslatef(0.047F, -0.67F, -0.4F);
...
//                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.235f, 0.173f, -0.6f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
            	GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.235f, 0.173f, -0.4f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.200000f, 0.525000f, -0.375000f);
             })
