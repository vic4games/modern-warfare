        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                 ...
                 GL11.glTranslatef(-0.500000f, 0.600000f, -6.574996f);
...
//                 GL11.glScalef(2f, 2f, 2f);
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                 ...
                 GL11.glScalef(2f, 2f, 2f);
                 GL11.glRotatef(0.000000f, 0f, 0f, 1f);
                 GL11.glTranslatef(-0.500000f, 0.600000f, -6.174996f);
                GL11.glRotatef(-0.300000f, 1f, 0f, 0f);
                })
            ...
            .withFirstPersonCustomPositioningReloading(Attachments.NightRaider.getRenderablePart(),
                    ...
                    //hand opens latch
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -0.5F, -1.4F);
                        GL11.glRotatef(90F, 1f, 0f, 0f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -0.5F, -1.4F);
            ...
            .withFirstPersonCustomPositioningReloading(Attachments.Holographic.getRenderablePart(),
                    ...
                    //hand opens latch
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -2.5F, -3.2F);
                        GL11.glRotatef(90F, 1f, 0f, 0f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -2.5F, -3.2F);
            ...
            .withFirstPersonCustomPositioningReloading(Attachments.MicroT1.getRenderablePart(),
                    ...
                    //hand opens latch
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -2.5F, -3.9F);
                        GL11.glRotatef(90F, 1f, 0f, 0f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glTranslatef(-0F, -2.5F, -3.9F);
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-1.600000f, 0.100000f, -6.749996f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                	  GL11.glScalef(2f, 2f, 2f);
                      GL11.glRotatef(-5.000000f, 1f, 0f, 0f);
                      ...
                      GL11.glTranslatef(0.100000f, 0.700000f, -6.849996f);
                  }, 350, 600))
         ...
         .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.M249Belt.getRenderablePart(),
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.24f, 0.55f);
                } 
                
                // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.315f, 0.55f);
                } 
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                    //System.out.println("Position me for Acog");
                	GL11.glTranslatef(0F, 0.235f, 0.45f);
                } 
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(5.000000f, 0f, 1f, 0f);
                GL11.glRotatef(20.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.500000f, 0.900000f, -6.299996f);
             })
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glRotatef(30.000000f, 0f, 1f, 0f);
                 GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                 GL11.glTranslatef(-1.200000f, 0.600000f, -6.399996f);
             })
             ...
             .withFirstPersonPositioningModifyingAlt((renderContext) -> {
            	 ...
            	 GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
            	 GL11.glTranslatef(-2.000000f, 0.000000f, -6.324996f);
             })
...
//                         GL11.glTranslatef(-0.675000f, -1.174999f, 0.175000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(4f, 4f, 4f);
...
//                         GL11.glScalef(4f, 4f, 4f);
            ...
            .withFirstPersonHandPositioningModifying(
            		(renderContext) -> {
                        ...
                        if(activeAttachment == Magazines.M249Mag) {
                        	GL11.glScalef(4f, 4f, 4f);
                            GL11.glRotatef(-90.000000f, 1f, 0f, 0f);
                            GL11.glRotatef(-55.000000f, 0f, 1f, 0f);
                            GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                            GL11.glTranslatef(-0.500000f, -1.774999f, -0.025000f);
                        } else {
                        	GL11.glScalef(4f, 4f, 4f);
                        	GL11.glRotatef(-70.000000f, 1f, 0f, 0f);
                        	GL11.glRotatef(-55.000000f, 0f, 1f, 0f);
                        	GL11.glRotatef(50.000000f, 0f, 0f, 1f);
                        	GL11.glTranslatef(-0.700000f, -1.524999f, 0.240000f);
                        }
                    }, 
                    (renderContext) -> {
                    	 GL11.glScalef(4f, 4f, 4f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.674999f, -0.725000f, 0.000000f);
                    }, 250, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(4f, 4f, 4f);
                        GL11.glRotatef(-85.000000f, 1f, 0f, 0f);
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-1.299999f, -0.450000f, 0.175000f);
                    }, 170, 0),
                    new Transition((renderContext) -> { // Reload position
                    	GL11.glScalef(4f, 4f, 4f);
                        GL11.glRotatef(-30.000000f, 1f, 0f, 0f);
