...
//      .withAmmoCapacity(25)
        ...
        "Caliber: 5.56x45mm", "Magazines:", "31rnd 5.56x45mm Magazine",
        "Fire Rate: Auto"))
        ...
        .withCompatibleAttachment(Magazines.HK33Mag, (model) -> {
        })
      .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof G36CIron1) {
                GL11.glTranslatef(-0.043F, -1.12F, -3.8F);
                GL11.glScaled(0.4F, 0.47F, 1.8F);
                GL11.glRotatef(-90F, 1f, 0f, 0f);
                GL11.glRotatef(-180F, 0f, 1f, 0f);
            } else if(model instanceof G36CIron2) {
                GL11.glTranslatef(-0.194F, -1.32F, -3.95F);
                ...
                GL11.glTranslatef(-0.101F, -1.27F, -0.13F);
        ...
        .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
            GL11.glTranslatef(-0.3F, -1.43F, -0.2F);
        ...
        .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
            GL11.glTranslatef(-0.17F, -1.16F, -0.65F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (model) -> {
            if(model instanceof Reflex) {
                ...
                GL11.glTranslatef(-0.123F, -1.52F, -0.9F);
                GL11.glScaled(0.07F, 0.07F, 0.07F);
            }
        })
        .withCompatibleAttachment(Attachments.Holo2, (model) -> {
            if(model instanceof Holographic) {
                GL11.glTranslatef(-0.053F, -1.3F, -0.6F);
                GL11.glScaled(0.55F, 0.55F, 0.55F);
            } else if(model instanceof Holo2) {
                GL11.glTranslatef(-0.12F, -1.57F, -0.5F);
        ...
        .withCompatibleAttachment(Attachments.Kobra, (model) -> {
            if(model instanceof Kobra) {
                ...
                GL11.glTranslatef(-0.122F, -1.52F, -1.05F);
                GL11.glScaled(0.07F, 0.07F, 0.07F);
            }
        })
        .withCompatibleAttachment(Attachments.MicroT1, (model) -> {
            if(model instanceof MicroT1) {
                GL11.glTranslatef(-0.17F, -1.4F, -0.6F);
                GL11.glScaled(0.3F, 0.3F, 0.3F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(-0.125F, -1.5F, -0.7F);
                GL11.glScaled(0.07F, 0.07F, 0.07F);
            }
        })
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.425000f, 0.975000f, -0.925000f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(5F, 0f, 0f, 1f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(-0.425000f, 0.975000f, -0.825000f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.35f, 0.83f, -0.83f);
                GL11.glRotatef(-0.3F, 1f, 0f, 0f);
                
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0f, 0.23f, 0.9f);
                }
                
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0f, 0.12f, 1.3f);
                }
                
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0f, 0.15f, 1.35f);
                }
...
//              GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.5f, 1f, -0.725000f);
                    }, 330, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.5f, 1.1f, -0.725000f);
                }, 150, 120),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-5F, 0f, 0f, 1f);
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glTranslatef(-0.425000f, 0.975000f, -0.9f);
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                    GL11.glTranslatef(-0.425000f, 0.975000f, -0.85f);
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.HK33Mag,
            ...
            .withFirstPersonCustomPositioningReloading(Magazines.HK33Mag,
                new Transition((renderContext) -> {
                    GL11.glTranslatef(0.8F, 1F, 0F);
                    GL11.glRotatef(-30F, 0f, 0f, 1f);
                }, 250, 1000),
            ...
            .withFirstPersonPositioningInspecting(
                  ...
                  new Transition((renderContext) -> {
                      ...
                      GL11.glTranslatef(0.2f, 1.1f, -0.8f);
                  }, 350, 600)
                    )
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0f, 0.23f, 0.95f);
                }
                
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(0f, 0.12f, 1.35f);
                }
