...
//		.withAmmoCapacity(25)
		...
		"Caliber: 5.56x45mm NATO", "Magazines:", "31rnd 5.56x45mm NATO Magazine",
		"Fire Rate: Auto"))
		.withCompatibleAttachment(CommonProxy.HK33Mag, (model) -> {
			GL11.glScaled(1.1F, 1.3F, 1.5F);
			GL11.glRotatef(05F, 1f, 0f, 0f);
			GL11.glTranslatef(-0.03F, 0F, 0.08F);
		})
	  .withCompatibleAttachment(CommonProxy.Extra, true, (model) -> {
			if(model instanceof G36CIron1) {
				...
				GL11.glTranslatef(0.13F, -1.545F, -2.4F);
				...
				GL11.glTranslatef(0.215F, -1.525F, 1F);
				GL11.glScaled(0.4F, 0.4F, 0.4F);
			}
		})
		.withCompatibleAttachment(CommonProxy.Silencer, (model) -> {
			GL11.glTranslatef(0.107F, -1.4F, -4.5F);
			GL11.glScaled(1F, 1F, 1F);
		})
		.withTextureNames("HK33", "Electric")
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonCustomPositioning(CommonProxy.HK33Mag, (player, itemStack) -> {
...
//				GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioningUnloading(CommonProxy.HK33Mag,
...
//					GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonCustomPositioningReloading(CommonProxy.HK33Mag,
				new Transition((player, itemStack) -> {
...
//					GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonPositioningZooming((player, itemStack) -> {
				...
				// Zoom
				GL11.glTranslatef(0.135F, -1.1f, 1.05f);
				GL11.glScaled(0.55F, 0.55F, 0.55F);
