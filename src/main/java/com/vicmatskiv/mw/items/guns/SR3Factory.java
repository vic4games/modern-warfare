    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glScaled(0.55F, 0.55F, 1.5F);
        ...
        .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
            GL11.glTranslatef(-0.21F, -1.38F, -1.5F);
        ...
        .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
            GL11.glTranslatef(-0.29F, -1.35F, -0.5F);
        ...
        .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                GL11.glTranslatef(-0.177F, -1.4F, -0.8F);
        ...
        .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
            GL11.glTranslatef(-0.182F, -1.1F, -0.8F);
        ...
        .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
            GL11.glTranslatef(-0.065F, -1.18F, -1.2F);
        ...
        .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                GL11.glTranslatef(-0.04F, -1.22F, -0.8F);
        ...
        .withCompatibleAttachment(Attachments.Vortex, (player, stack) -> {
                GL11.glTranslatef(-0.272F, -1.42F, -1.2F);
        ...
        .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                GL11.glTranslatef(-0.04F, -1.22F, -0.6F);
                GL11.glScaled(0.65F, 0.65F, 0.65F);
        },(model) -> {
            if(model instanceof Reflex2) {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.M4Rail, true, (model) -> {
            if(model instanceof AKRail) {
                ...
                GL11.glTranslatef(-0.202F, -1.27F, -2f);
                GL11.glScaled(0.6F, 0.8F, 0.8F);
            }
        })
        .withTextureNames("VSS_Vintorez")
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.1f, 0.75f, -0.4f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2.000000f, 2.000000f, 2.000000f);
                GL11.glRotatef(7.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.1f, 0.75f, -0.33f);
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.18f, 0.8f, -0.4f);
                    }, 400, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-2F, 1f, 0f, 0f);
                    GL11.glTranslatef(-0.18f, 0.75f, -0.4f);
                }, 350, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.18f, 0.75f, -0.3f);
                }, 160, 100),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-20.000000f, 0f, 0f, 1f);
                    GL11.glRotatef(-2F, 1f, 0f, 0f);
                    GL11.glTranslatef(-0.18f, 0.75f, -0.35f);
                }, 160, 0)
            )
...
//                    }, 500, 1000),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
             ...
             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    ...
                    GL11.glTranslatef(0F, 0.22f, 0.1f);
                } 
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.78f, -0.05f);
                GL11.glRotatef(-0.5F, 1f, 0f, 0f);

             // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.22f, 0.05f);
                } 
