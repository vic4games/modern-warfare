...
//		.withAmmo(CommonProxy.Remington870Mag)
        ...
        .withCompatibleAttachment(Attachments.RMR, (model) -> {
            ...
            GL11.glTranslatef(0.155F, -1.55F, 0F);
            GL11.glScaled(0.28F, 0.28F, 0.28F);
            } else if(model instanceof Reflex2) {
                GL11.glTranslatef(0.195F, -1.55F, -0.8F);
                GL11.glScaled(0.1F, 0.1F, 0.1F);
            }
        })
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
				...
				GL11.glScaled(4F, 4F, 4F);
				GL11.glTranslatef(-0.475000f, 1.149999f, -1.249999f);
				
//				GL11.glRotatef(30F, 0f, 1f, 0f);
//                GL11.glRotatef(30F, 0f, 0f, 1f);
//                GL11.glRotatef(5F, 1f, 0f, 0f);
//                GL11.glScaled(4F, 4F, 4F);
//                GL11.glTranslatef(-0.475000f, 1.25f, -1.249999f);
				})
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(5F, 0f, 0f, 1f);
                GL11.glScaled(4F, 4F, 4F);
                GL11.glTranslatef(-0.475000f, 1.149999f, -1.1f);
            ...
            .withFirstPersonPositioningEjectSpentRound(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScaled(4F, 4F, 4F);
                        GL11.glTranslatef(-0.475000f, 1.25f, -1.2f);
                    }, 130, 0),
                    
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(30F, 0f, 1f, 0f);
                        GL11.glRotatef(31F, 0f, 0f, 1f);
...
//                      GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glTranslatef(-0.8f, 0.8f, -1.7f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                      ...
                      GL11.glTranslatef(-0.1f, 1f, -1.7f);
                  }, 350, 600)
                    )
			...
			.withFirstPersonPositioningZooming((renderContext) -> {
				...
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holo2)) {
					//System.out.println("Position me for Holo");
					GL11.glTranslatef(-0.005F, 0.065f, 0.8f);
				} 
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                    //System.out.println("Position me for Reflex");
                    GL11.glTranslatef(0F, 0.07f, 1.2f);
                } 
			...
			.withFirstPersonPositioningRunning((renderContext) -> {
				...
				GL11.glTranslatef(-0.7f, 1.1f, -1f);
			 })
			 .withFirstPersonPositioningModifying((renderContext) -> {
			     ...
			     GL11.glRotatef(-25.000000f, 0f, 0f, 1f);
			     GL11.glTranslatef(-0.850000f, 0.725000f, -1.699999f);
			 })
			 ...
			 .withFirstPersonHandPositioning(
					 (renderContext) -> {
                         ...
                         GL11.glTranslatef(-0.075000f, -0.550000f, -0.015000f);
					 }, 
					 (renderContext) -> {
						 GL11.glScalef(3f, 3f, 3f);
			...
			.withFirstPersonHandPositioningModifying(
					 (renderContext) -> {
						 ...
						 GL11.glRotatef(-60f, 20f, 20f, -25f);
					 }, 
					 (renderContext) -> {
					     GL11.glScalef(3f, 3f, 3f);
                         GL11.glRotatef(-90.000000f, 1f, 0f, 0f);
