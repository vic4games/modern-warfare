...
public class M38Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        "Type: Designated Marskmen Rifle/Squad Automatic Weapon", 
        "Damage: 7", 
        ...
        .withCompatibleAttachment(Attachments.M4FrontSight, (model) -> {
...
//                GL11.glTranslatef(-0.17f, 1.15f, -0.35f);
                ...
                GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                GL11.glTranslatef(-0.12f, 1.2f, -0.55f);
                })
...
//                GL11.glRotatef(-1F, 1f, 0f, 0f); 
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.3f, 1.15f, -0.55f);
                    }, 270, 0),
...
//                  GL11.glScaled(0.55F, 0.55F, 0.55F);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
             ...
             // Standard Iron Sight Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(0F, 0.03f, 0.15f);
                } 
