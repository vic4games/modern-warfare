...
//		.withAmmoCapacity(20)
		...
		.withInformationProvider(stack -> Arrays.asList("Type: Designated marksmen rifle", "Damage: 15", 
        ...
        .withCompatibleAttachment(CommonProxy.Amber, 
                (a, i) -> {
                    i.setActiveTextureIndex(CommonProxy.Amber.getTextureVariantIndex("M14Amber"));
                }, 
                (a, i) -> {
                }
        )
		...
		.withCompatibleAttachment(CommonProxy.Extra, true, (model) -> {
			if(model instanceof AKMiron1) {
				...
				GL11.glScaled(0F, 0F, 0F);
					...
					GL11.glTranslatef(0.135F, -1.58F, 0.5F);
					GL11.glScaled(0.4F, 0.4F, 0.4F);
			} else if(model instanceof AKMiron2) {
				GL11.glTranslatef(0.129F, -1.63F, -2.08F);
				GL11.glScaled(0F, 0F, 0F);
			} else if(model instanceof FALIron) {
				GL11.glTranslatef(0.133F, -1.39F, -3.85F);
				...
				GL11.glTranslatef(0.159F, -1.43F, 0.42F);
		...
		.withCompatibleAttachment(CommonProxy.M14Rail, true, (model) -> {
			if(model instanceof M14Rail) {
				GL11.glTranslatef(0.1F, -1.53F, -0.6F);
		...
		.withCompatibleAttachment(CommonProxy.ACOG, (player, stack) -> {
			...
			.withCompatibleAttachment(CommonProxy.Scope, (player, stack) -> {
				...
				GL11.glTranslatef(0.055F, -1.62F, 0.2F);
				GL11.glScaled(0.6F, 0.6F, 0.6F);
			},(model) -> {
			...
			.withCompatibleAttachment(CommonProxy.HP, (player, stack) -> {
				...
				GL11.glTranslatef(0.055F, -1.6F, 0.2F);
				GL11.glScaled(0.6F, 0.6F, 0.6F);
		},(model) -> {
			 if(model instanceof LPscope) {
		...
		.withCompatibleAttachment(CommonProxy.Silencer762x51, (model) -> {
			GL11.glTranslatef(0.12F, -1.46F, -5.6F);
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
				GL11.glTranslatef(0.5F, -0.4F, -0.05F);
				GL11.glRotatef(45F, 0f, 1f, 0f);
			...
			.withFirstPersonPositioningRecoiled((renderContext) -> {
				...
				GL11.glRotatef(45F, 0f, 1f, 0f);
				GL11.glScaled(0.55F, 0.55F, 0.55F);
				GL11.glTranslatef(-0.4F, -0.8F, 0.95F);
			...
			.withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
				...
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), CommonProxy.ACOG)) {
					...
					GL11.glTranslatef(0F, 0.365f, 0.35f);
				} 
				...
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), CommonProxy.HP)) {
					//System.out.println("Position me for Scope");
					GL11.glTranslatef(0F, 0.335f, -0.2f);
				} 
...
//				GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonPositioningReloading(
					...
					new Transition((renderContext) -> { // Reload position
						GL11.glTranslatef(0.3F, -0.55F, -0.4F);
						GL11.glRotatef(45F, 0f, 1f, 0f);
...
//					GL11.glTranslatef(-0.4F, -0.8F, 0.9F);
			...
			.withFirstPersonHandPositioning(
					 (renderContext) -> {
						 ...
						 GL11.glTranslatef(0.73f, -0.18f, 0.2f);
			...
			.withFirstPersonRightHandPositioningReloading(
					...
					new Transition((renderContext) -> { // Reload position
						GL11.glScalef(1.8f, 1.8f, 2.5f);
						 GL11.glTranslatef(0.15f, 0f, -0.05f);
