	...
	public Item createGun(CommonProxy commonProxy) {
		...
		.withCompatibleAttachment(CommonProxy.AKMIron, true, (model) -> {
			if(model instanceof ScarIron1) {
				GL11.glTranslatef(0.175F, -1.6F, 1.93F);
				GL11.glScaled(0.21F, 0.21F, 0.21F);
			} else if(model instanceof ScarIron2) {
				GL11.glTranslatef(0.2235F, -1.5F, -0.88F);
		...
		.withCompatibleAttachment(CommonProxy.Holo2, (model) -> {
			...
			GL11.glTranslatef(.264F, -1.49F, 0.2F);
			GL11.glScaled(0.5F, 0.5F, 0.5F);
			} else if(model instanceof Holo2) {
				GL11.glTranslatef(0.202F, -1.74F, 0.3F);
		...
		.withCompatibleAttachment(CommonProxy.Kobra, (model) -> {
			...
			GL11.glScaled(0.5F, 0.5F, 0.5F);
				...
				GL11.glTranslatef(0.202F, -1.74F, -0.5F);
				GL11.glScaled(0.06F, 0.06F, 0.06F);
			}
		})
		.withCompatibleAttachment(CommonProxy.Silencer, (model) -> {
			GL11.glTranslatef(0.11F, -1.08F, -2.78F);
			GL11.glScaled(1F, 1F, 1F);
		})
		.withTextureNames("MP7", "Red", "Black", "Desert", "Green", "Blue", "Orange", "Purple", 
				"Cyan", "White", "Arctic", "Electric", "Redline", "Fade", "IceAndFire", "Fade2", "GreenElectric", "Handgun",
			...
			.withFirstPersonPositioning((player, itemStack) -> {
				...
				GL11.glScaled(0.55F, 0.55F, 0.55F);
					...
					if(itemStack.stackTagCompound != null && reloadingProgress > 0 && reloadingProgress < 0.2f) {
						...
						// Zoom
						GL11.glTranslatef(0.135F, -1.08f, 0.8f);
						GL11.glScaled(0.55F, 0.55F, 0.55F);
						...
						if(Weapon.isActiveAttachment(itemStack, CommonProxy.Kobra)) {
							//System.out.println("Position me for Holo");
							GL11.glTranslatef(1.373F, -1.205f, 3.7f);
						} 
