...
public class M4A1Factory implements GunFactory {
	...
	public Item createGun(CommonProxy commonProxy) {
        ...
        .withCompatibleAttachment(Attachments.M38FrontSight, (model) -> {
...
//				GL11.glScaled(0.55F, 0.5F, 1F);
	   ...
	   .withCompatibleAttachment(AuxiliaryAttachments.AR15Iron, true, (model) -> {
		...
		.withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
            GL11.glTranslatef(-0.18F, -1.14F, -0.8F);
		...
		.withCompatibleAttachment(Attachments.EotechHybrid2, (player, stack) -> {
            GL11.glTranslatef(-0.041F, -1.25F, -1.1F);
            GL11.glScaled(0.65F, 0.65F, 0.65F);
        },(model) -> {
	    ...
	    .withCompatibleAttachment(Attachments.Vortex, (player, stack) -> {
                GL11.glTranslatef(-0.28F, -1.48F, -1.1F);
...
//                GL11.glTranslatef(-0.17f, 1.15f, -0.35f);
...
//                GL11.glRotatef(-0.5F, 1, 0, 0);
             ...
             // Standard Iron Sight Zoom
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(-0.01F, 0.03f, 0.35f);
                } 
                
                // ACOG Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                    //System.out.println("Position me for Acog");
                    GL11.glTranslatef(-0.003F, -0.015f, 0.15f);
                } 
             ...
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                    //System.out.println("Position me for Holo");
                    GL11.glTranslatef(-0.004F, 0.025f, -0.05f);
                } 
