...
//				GL11.glScaled(0.55F, 0.5F, 1F);
	   ...
	   .withCompatibleAttachment(AuxiliaryAttachments.AR15Iron, true, (model) -> {
		...
		.withCompatibleAttachment(Attachments.Specter, renderContext -> {
            ...
            if(instance != null) {
                ...
                if(activeAttachment == Attachments.AR57Handguard) {
                    ...
                    GL11.glTranslatef(-0.18F, -1.14F, -0.5F);
                    GL11.glScaled(0.4F, 0.4F, 0.4F);
                }
            }
        },(model) -> {
		...
		.withCompatibleAttachment(Attachments.HP, renderContext -> {
		    PlayerWeaponInstance instance = renderContext.getWeaponInstance();
            if(instance != null) {
                ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                        AttachmentCategory.GUARD, instance);
                if(activeAttachment == Attachments.AR57Handguard) {
                    GL11.glTranslatef(-0.3F, -1.5F, -0.5F);
                    GL11.glScaled(0.75F, 0.75F, 0.75F);
                } else {
		...
		.withCompatibleAttachment(Attachments.BijiaReflex, renderContext -> {
            ...
            if(instance != null) {
                ...
                if(activeAttachment == Attachments.AR57Handguard) {
                    ...
                    GL11.glTranslatef(-0.066F, -1.21F, -1F);
                    GL11.glScaled(0.45F, 0.45F, 0.45F);
                }
            }
		},(model) -> {
		...
		.withCompatibleAttachment(Attachments.EotechHybrid2, renderContext -> {
            ...
            if(instance != null) {
                ...
                if(activeAttachment == Attachments.AR57Handguard) {
                    ...
                    GL11.glTranslatef(-0.041F, -1.25F, -1F);
                    GL11.glScaled(0.65F, 0.65F, 0.65F);
                }
            }
        },(model) -> {
	    ...
	    .withCompatibleAttachment(Attachments.Vortex, renderContext -> {
            ...
            if(instance != null) {
                ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                        AttachmentCategory.GUARD, instance);
                if(activeAttachment == Attachments.AR57Handguard) {
                    GL11.glTranslatef(-0.28F, -1.58F, -1.2F);
		...
		.withCompatibleAttachment(Attachments.MicroT1, renderContext -> {
            ...
            if(instance != null) {
                ...
                if(activeAttachment == Attachments.AR57Handguard) {
                    ...
                    GL11.glTranslatef(-0.18F, -1.45F, -1.2F);
                    GL11.glScaled(0.38F, 0.38F, 0.38F);
                    }
                }
            },(model) -> {
		...
		.withCompatibleAttachment(Attachments.AimpointCompM5, renderContext -> {
            ...
            if(instance != null) {
                ...
                if(activeAttachment == Attachments.AR57Handguard) {
                    ...
                    GL11.glTranslatef(-0.18F, -1.45F, -0.6F);
                    GL11.glScaled(0.38F, 0.38F, 0.38F);
                    }
                }
        },(model) -> {
		...
		.withCompatibleAttachment(Attachments.RMR, renderContext -> {
            ...
            if(instance != null) {
                ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                        AttachmentCategory.GUARD, instance);
                if(activeAttachment == Attachments.AR57Handguard) {
                    GL11.glTranslatef(-0.17F, -1.52F, -0.7F);
                    GL11.glScaled(0.32F, 0.32F, 0.32F);
                } else {
                    GL11.glTranslatef(-0.17F, -1.45F, -1.2F);
                    GL11.glScaled(0.32F, 0.32F, 0.32F);
                    }
                }
        },(model) -> {
		...
		.withRenderer(new WeaponRenderer.Builder()
			...
			.withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.12f, 1.2f, -0.65f);
			...
			.withFirstPersonPositioningReloading(
			        ...
			        new Transition((renderContext) -> { // Reload position
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.33f, 1.5f, -0.35f);
                        } else {
    			            GL11.glRotatef(-5F, 1f, 0f, 0f);
                            GL11.glRotatef(44F, 0f, 1f, 0f);
                            GL11.glRotatef(-4F, 0f, 0f, 1f);
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.25f, 1.15f, -0.55f);
                        }
                    }, 280, 0),
			        ...
			        new Transition((renderContext) -> { // Reload position
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.33f, 1.51f, -0.35f);
                        } else {
                            GL11.glRotatef(-18F, 1f, 0f, 0f);
                            GL11.glRotatef(43F, 0f, 1f, 0f);
                            GL11.glRotatef(-10F, 0f, 0f, 1f);
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.3f, 1.25f, -0.55f);
                        }
                    }, 270, 0),
			        ...
			        new Transition((renderContext) -> { // Reload position
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.33f, 1.54f, -0.35f);
                        } else {
                            GL11.glRotatef(-16F, 1f, 0f, 0f);
                            GL11.glRotatef(43F, 0f, 1f, 0f);
                            GL11.glRotatef(-18F, 0f, 0f, 1f);
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.4f, 1.2f, -0.55f);
                        }
                    }, 240, 0),
                    new Transition((renderContext) -> { // Reload position
                        RenderContext<?> rc = (RenderContext<?>) renderContext;
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.33f, 1.58f, -0.35f);
                        } else {
                            GL11.glRotatef(-20F, 1f, 0f, 0f);
                            GL11.glRotatef(43F, 0f, 1f, 0f);
                            GL11.glRotatef(-18F, 0f, 0f, 1f);
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.43f, 1.15f, -0.55f);
                        }
                    }, 220, 170),
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                        GL11.glTranslatef(-0.2f, 1.15f, -0.55f);
                    }, 260, 0),
                    new Transition((renderContext) -> { // Reload position
			...
			.withFirstPersonPositioningUnloading(
			        ...
			        new Transition((renderContext) -> { // Reload position
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glRotatef(13F, 0f, 0f, 1f);
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.33f, 1.4f, -0.35f);
                        } else {
			        ...
			        new Transition((renderContext) -> { // Reload position
                        ...
                        if(activeAttachment == Attachments.AR57Handguard) {
                            ...
                            GL11.glScalef(3.00000f, 3.00000f, 3.00000f);
                            GL11.glTranslatef(-0.2f, 1.1f, -0.55f);
                        }
                    }, 200, 0),
			        new Transition((renderContext) -> { // Reload position
                        RenderContext<?> rc = (RenderContext<?>) renderContext;
			...
			.withFirstPersonPositioningZooming((renderContext) -> {
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                    ...
                    if(activeAttachment == Attachments.AR57Receiver) {
                        ...
                        GL11.glTranslatef(0F, 0.03f, 0.25f);
                    }
                } 
				...
				if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HP)) {
                    ...
                    ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                            AttachmentCategory.RECEIVER, rc.getWeaponInstance());
                    if(activeAttachment == Attachments.AR57Receiver) {
                        GL11.glTranslatef(0.001F, 0.14f, -0.2f);
                    } else {
             ...
             // Holo Zoom
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                    ...
                    if(activeAttachment == Attachments.AR57Receiver) {
                        ...
                        GL11.glTranslatef(-0.004F, 0.025f, 0f);
                    }
                } 
             ...
             // Standard Iron Sight Zoom
                ...
                if(Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HP)) {
                    ...
                    ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                            AttachmentCategory.RECEIVER, rc.getWeaponInstance());
                    if(activeAttachment == Attachments.AR57Receiver) {
                        GL11.glTranslatef(0.001F, 0.14f, -0.25f);
                    } else {
                        GL11.glTranslatef(0.001F, 0.02f, 0.35f);
                    }
                } 
			 ...
			 .withFirstPersonHandPositioning(
			         (renderContext) -> {
                         ...
                         if(activeAttachment == Attachments.Grip2 ||
                             ...
                             GL11.glRotatef(-45.000000f, 0f, 1f, 0f);
                             GL11.glRotatef(35.000000f, 0f, 0f, 1f);
                             GL11.glTranslatef(0.325000f, -0.100000f, 0.190000f);
