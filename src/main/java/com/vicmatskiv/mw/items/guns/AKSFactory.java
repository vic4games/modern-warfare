...
import com.vicmatskiv.mw.models.AKS;
...
public class AKSFactory implements GunFactory {
...
//		.withAmmoCapacity(30)
		...
		.withInformationProvider(stack -> Arrays.asList("Damage: 7.1", 
		...
		.withTextureNames("AKS", "AKGold", "Electric")
