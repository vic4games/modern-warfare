...
import com.vicmatskiv.mw.models.S686;
import com.vicmatskiv.weaponlib.Weapon;
import com.vicmatskiv.weaponlib.WeaponRenderer;
import com.vicmatskiv.weaponlib.animation.Transition;
import com.vicmatskiv.weaponlib.crafting.CraftingComplexity;

public class S686Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withCrafting(CraftingComplexity.MEDIUM, 
                ...
                Ores.INGOT_STEEL)
        .withInformationProvider(stack -> Arrays.asList("Type: Shotgun", "Damage per Pellet: 5", "Pellets per Shot: 8", 
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.S686doublebarrel, true, (model) -> {
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningLoadIterationCompleted((renderContext) -> {
                ...
                GL11.glTranslatef(-0.5f, 0.4f, -1.5f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glRotatef(5F, 0f, 0f, 1f);
                GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                GL11.glTranslatef(-0.47f, 0.4f, -1.3f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                GL11.glTranslatef(0.250000f, 0.28f, -1.2f);
...
//              // Holo Zoom
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.S686doublebarrel.getRenderablePart(), (renderContext) -> {
                })
                
            .withFirstPersonCustomPositioningLoadIterationCompleted(AuxiliaryAttachments.S686doublebarrel.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0f, -0.3f, -0f);
                GL11.glRotatef(35F, 1f, 0f, 0f);
                GL11.glScalef(1f, 1f, 1f);
                })
                
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.S686doublebarrel.getRenderablePart(),
            ...
            .withFirstPersonCustomPositioningAllLoadIterationsCompleted(AuxiliaryAttachments.S686doublebarrel.getRenderablePart(),
                new Transition((renderContext) -> { // Reload position
                    GL11.glTranslatef(0f, -0.3f, -0f);
                    GL11.glRotatef(35F, 1f, 0f, 0f);
                    GL11.glScalef(1f, 1f, 1f);
            ...
            .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.S686doublebarrel.getRenderablePart(),  
                new Transition((renderContext) -> { // Reload position
                    GL11.glTranslatef(0f, -0.3f, -0f);
                    GL11.glRotatef(35F, 1f, 0f, 0f);
                    GL11.glScalef(1f, 1f, 1f);
            ...
            .withFirstPersonPositioningReloading(
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                    GL11.glTranslatef(-0.45f, 0.5f, -1.5f);
                }, 300, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                    GL11.glTranslatef(-0.45f, 0.35f, -1.5f);
                }, 120, 0),
            ...
            .withFirstPersonPositioningLoadIteration(   
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(5F, 1f, 0f, 0f);
                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                    GL11.glTranslatef(-0.48f, 0.4f, -1.5f);
                }, 220, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                    GL11.glTranslatef(-0.47f, 0.4f, -1.5f);
                }, 190, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                GL11.glTranslatef(0.250000f, 0.28f, -1.5f);
...
//              // Holo Zoom
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.350000f, 0.200000f, -0.6f);
             })
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glTranslatef(-0.725000f, -0.050000f, -1.324999f);
             }) 
