...
public class KBP9A91Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
       ...
       .withCompatibleAttachment(Magazines.KBP9A91Mag, (model) -> {
        ...
        .withCompatibleAttachment(Attachments.Silencer9x39mm, (model) -> {
        ...
        .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
            if(model instanceof AKMiron1) {
                ...
                GL11.glTranslatef(-0.23F, -1.6F, -2.3F);
                ...
                GL11.glTranslatef(-0.165F, -1.27F, -3.8F);
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.28f, 0.9f, -0.27f);
                    }, 400, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glTranslatef(-0.28f, 0.85f, -0.27f);
                }, 350, 0),
                ...
                new Transition((renderContext) -> { // Reload position
                    ...
                    GL11.glRotatef(-20.000000f, 0f, 0f, 1f);
                    GL11.glRotatef(-2F, 1f, 0f, 0f);
                    GL11.glTranslatef(-0.28f, 0.85f, -0.37f);
                }, 160, 0)
            )
            ...
            .withFirstPersonPositioningInspecting(
                    new Transition((renderContext) -> {
                        ...
                        GL11.glRotatef(-20.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.8f, 0.8f, -0.325000f);
                    }, 300, 600),
                  new Transition((renderContext) -> {
                      GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                      ...
                      GL11.glTranslatef(0.225000f, 1.075000f, -0.6f);
                  }, 350, 600)
                    )
...
//                    }, 500, 1000),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.78f, -0.8f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                GL11.glRotatef(45F, 0f, 1f, 0f);
                GL11.glScalef(3.000000f, 3.000000f, 3.000000f);
                GL11.glTranslatef(0.350000f, 0.78f, -0.7f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
             ...
             .withFirstPersonPositioningModifying((renderContext) -> {
                 ...
                 GL11.glTranslatef(-0.800000f, 0.675000f, -0.675000f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(-45.000000f, 0f, 1f, 0f);
                         GL11.glRotatef(25.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(0.200000f, -0.125000f, 0.250000f);
                     }, 
                     (renderContext) -> {
