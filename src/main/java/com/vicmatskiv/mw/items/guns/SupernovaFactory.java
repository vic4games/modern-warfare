...
//                GL11.glRotatef(-70F, 1f, 0f, 0f);
            ...
            .withFirstPersonPositioningEjectSpentRound(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(-0.2f, 0.48f, -1.55f);
                    }, 100, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(-0.2f, 0.65f, -1.3f);
                    }, 130, 60),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(-0.2f, 0.6f, -1.45f);
                    }, 110, 0)
            ...
            .withFirstPersonPositioningEjectSpentRoundAimed(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(0.2f, 0.3f, -1.1f);
                    }, 100, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(0.2f, 0.4f, -0.85f);
                    }, 130, 60),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-2F, 1f, 0f, 0f);
                        GL11.glScalef(4.000000f, 4.000000f, 4.000000f);
                        GL11.glTranslatef(0.2f, 0.38f, -1f);
                    }, 110, 0)
