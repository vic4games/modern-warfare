...
public class GasCanFactory implements MeleeFactory {
        ...
        return new ItemMelee.Builder()
                ...
                .withRenderer(
                        new MeleeRenderer.Builder()
                                .withModId(ModernWarfareMod.MODID)
                                .withModel(new com.vicmatskiv.mw.models.GasCan())
                                ...
                                .withFirstPersonPositioning(context -> {
                                    ...
                                    GL11.glTranslatef(-0.750000f, 0.875000f, -1.050000f);
                                    })
                                ...
                                .withFirstPersonHandPositioning(
                                        ...
                                        context -> { // left hand
                                            ...
                                            GL11.glTranslatef(0.350000f, -0.475000f, 0.100000f);
                                        },
                                        ...
                                        context -> { // right hand
                                            ...
                                            GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                                            GL11.glTranslatef(0.225000f, -0.300000f, 0.050000f);
