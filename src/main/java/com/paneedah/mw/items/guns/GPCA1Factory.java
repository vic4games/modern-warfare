...
import com.paneedah.mw.models.GPCA1;
        ...
        .withRenderer(new WeaponRenderer.Builder()
            ...
            .withThirdPersonPositioning((renderContext) -> {
             ...
             .withFirstPersonPositioning((renderContext) -> {
                ...
                GL11.glTranslatef(-0.325000f, 1.8f, -2.3f);
                
//                GL11.glRotatef(42F, 0f, 1f, 0f);
//                GL11.glScalef(2f, 2f, 2f);
//                GL11.glRotatef(14.000000f, 0f, 0f, 1f);
//                GL11.glTranslatef(-0.3f, 1.9f, -2.3f);
                })
            ...
            .withFirstPersonPositioningRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2f, 2f, 2f);
                GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.325000f, 1.8f, -1.9f);
                })
            ...
            .withFirstPersonPositioningProning((renderContext) -> {
                ...
                GL11.glScalef(2f, 2f, 2f);
                GL11.glRotatef(14.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(-0.4f, 1.2f, -2.5f);
                })
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.LaserProjectile.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 50F);
                GL11.glScaled(1F, 1F, 150F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.LaserProjectile.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 50F);
                GL11.glScaled(1F, 1F, 150F);
                })
                
            .withFirstPersonPositioningCustomProningRecoiled(AuxiliaryAttachments.LaserProjectile.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 50F);
                GL11.glScaled(1F, 1F, 150F);
                })
...
//                    }, 200, 200),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.3f, 2f, -2.15f);
                    }, 150, 150),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(42F, 0f, 1f, 0f);
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(14.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.3f, 1.9f, -2.2f);
                    }, 200, 0))
...
//                    }, 200, 200),
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.325000f, 2.4f, -2.3f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(25F, 0f, 1f, 0f);
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.325000f, 2f, -2.3f);
                    }, 120, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(35F, 0f, 1f, 0f);
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(5.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.325000f, 1.9f, -2.3f);
                    }, 270, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(40F, 0f, 1f, 0f);
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(0.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.325000f, 1.5f, -2.3f);
                    }, 190, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glRotatef(45F, 0f, 1f, 0f);
                        GL11.glScalef(2f, 2f, 2f);
                        GL11.glRotatef(13.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.325000f, 1.7f, -2.3f);
                    }, 190, 0)
                    )
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glScalef(2f, 2f, 2f);
                GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(0.100000f, 1.200000f, -1.775000f);
            ...
            .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                ...
                GL11.glScalef(2f, 2f, 2f);
                GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(0.100000f, 1.200000f, -1.2f);
            ...
            .withFirstPersonPositioningRunning((renderContext) -> {
                ...
                GL11.glRotatef(15.000000f, 0f, 0f, 1f);
                GL11.glTranslatef(0.075000f, 1.6f, -1f);
             })
             ...
             .withFirstPersonHandPositioning(
                     (renderContext) -> {
                         ...
                         GL11.glRotatef(10.000000f, 0f, 0f, 1f);
                         GL11.glTranslatef(-0.050000f, -0.750000f, 0.025000f);
                     }, 
                     (renderContext) -> {
                         GL11.glScalef(4f, 4f, 4f);
                         ...
                         GL11.glTranslatef(0.475000f, -1.624999f, 0.225000f);
                     })
...
//                    }, 250, 1000),
            ...
            .build())
            .withSpawnEntityDamage(400f)
//            .withSpawnEntitySpeed(3f)
//           .withSpawnEntityExplosionRadius(3f)
//        .withSpawnEntityExplosionRadius(1f)
