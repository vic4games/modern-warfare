...
import com.paneedah.mw.models.P2022;
import com.paneedah.mw.models.P2022Slide;
import com.paneedah.mw.models.P226frontsight;
...
public class P2022Factory implements GunFactory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        ...
        .withZoom(0.9f)
        .withMaxShots(1)
        .withShootSound("p2022")
        .withSilencedShootSound("colt_m45a1_silenced")
        .withReloadSound("p2022_reload")
        .withUnloadSound("p2022_unload")
...
//        })
        .withCompatibleAttachment(AuxiliaryAttachments.P2022_Slide, true, (model) -> {
            if(model instanceof P2022Slide) {
                GL11.glScaled(1F, 1F, 1F);
//                GL11.glTranslatef(0F, 0F, 0.5F);
            }
            else if(model instanceof M9A1rearsight) {
                GL11.glTranslatef(-0.153F, -1.18F, -0.07F);
                GL11.glScaled(0.28F, 0.2F, 0.3F);
            }
            else if(model instanceof P226frontsight) {
                GL11.glTranslatef(-0.142F, -1.185F, -1.9F);
                GL11.glScaled(0.2F, 0.2F, 0.2F);
            }
        })
        .withCompatibleAttachment(Magazines.P2022Mag, (model) -> {
...
//                GL11.glTranslatef(-0.5f, 1.1f, -1.8f);
            ...
            .withFirstPersonPositioningCustomRecoiled(AuxiliaryAttachments.P2022_Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.5F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
                
            .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.P2022_Slide.getRenderablePart(), (renderContext) -> {
                GL11.glTranslatef(0F, 0F, 0.5F);
//              GL11.glRotatef(45F, 0f, 1f, 0f);
//              GL11.glScaled(0.55F, 0.55F, 0.55F);
                })
            ...
            .withFirstPersonCustomPositioning(AuxiliaryAttachments.P2022_Slide.getRenderablePart(), (renderContext) -> {
            ...
            .withFirstPersonPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.825000f, 0.500000f, -1.075000f);
                    }, 180, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.825000f, 0.65000f, -1.075000f);
                    }, 140, 60),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.825000f, 0.150000f, -1.075000f);
                    }, 80, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
                        GL11.glRotatef(-50.000000f, 1f, 0f, 0f);
                        ...
                        GL11.glTranslatef(-0.825000f, 0.220000f, -1.075000f);
                    }, 50, 100)
                )
            ...
            .withFirstPersonPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(20.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(-0.150000f, 0.425000f, -1.549999f);
                    }, 150, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.150000f, 1.225000f, -1.449999f);
                    }, 90, 0),
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(-0.150000f, 1.225000f, -1.549999f);
                    }, 100, 0)
                )
                    
            .withFirstPersonCustomPositioningReloading(Magazines.P2022Mag,
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 3F, 0.1F);
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 1.1F, 0.1F);
                    }, 250, 1000),
            ...
            .withFirstPersonCustomPositioningUnloading(Magazines.P2022Mag,
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 3F, 0.1F);
            ...
            .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.P2022_Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
            ...
            .withFirstPersonCustomPositioningUnloading(AuxiliaryAttachments.P2022_Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.6F);
            ...
            .withThirdPersonCustomPositioningReloading(AuxiliaryAttachments.P2022_Slide.getRenderablePart(),
                    new Transition((renderContext) -> {
                    }, 250, 1000),
                    new Transition((renderContext) -> {
                        GL11.glTranslatef(0F, 0F, 0.5F);
            ...
            .withFirstPersonPositioningDrawing(
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glTranslatef(0.325000f, 0.975000f, -1.649999f);
                    }, 50, 0),
                    new Transition((renderContext) -> { // Reload position
                        GL11.glScaled(2F, 2F, 2F);
            ...
            .withFirstPersonCustomPositioningDrawing(AuxiliaryAttachments.P2022_Slide.getRenderablePart(),
                    new Transition((renderContext) -> { // Reload position
                    }, 150, 0),
                    new Transition((renderContext) -> { // Reload position
                    }, 130, 0),
            ...
            .withFirstPersonPositioningZooming((renderContext) -> {
                ...
                GL11.glTranslatef(0.350000f, 0.6f, -2f);
...
//                       GL11.glTranslatef(0.390000f, -0.525000f, 0.135000f);
            ...
            .withFirstPersonLeftHandPositioningReloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-50.000000f, 0f, 1f, 0f);
                        GL11.glRotatef(30.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.300000f, -0.575000f, 0.050000f);
                    }, 250, 0),
            ...
            .withFirstPersonLeftHandPositioningUnloading(
                    ...
                    new Transition((renderContext) -> { // Reload position
                        ...
                        GL11.glRotatef(-10.000000f, 0f, 0f, 1f);
                        GL11.glTranslatef(0.150000f, -0.075000f, 0.400000f);
                    }, 330, 200),
